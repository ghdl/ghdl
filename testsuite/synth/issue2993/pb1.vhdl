...
architecture rtl of pb1 is
  ...
  begin
    ...
    report "pos="&natural'image(pos);
    assert pos <= 48 report "Unsupported sv mode" severity failure;

    -- assign n117 = n87 == 32'b00000000000000000000000000100111; // 39 : 6-bits
    -- assign n122 = n87[4:0];             // 7 - Error: should not truncate
    -- assign n124 = n122 + 5'b01011;      // 18 - ERROR: Should not add
