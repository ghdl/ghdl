...
entity externalerr08_sub is
  port (clk : std_logic;
        rst : std_logic;
        a : std_logic_vector(7 downto 0);
        o : out std_logic_vector(7 downto 0));
end externalerr08_sub;

architecture behav of externalerr08_sub is
...
architecture behav of externalerr08 is
  signal r2: integer;
begin
  dut : entity work.externalerr08_sub
    port map (clk => clk,
              rst => rst,
              a => a,
              o => o);
