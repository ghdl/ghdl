...
__EXPRESSION_TRANSLATION = {
    ...
    nodes.Iir_Kind.Selected_By_All_Name: IndexedObjectOrFunctionCallSymbol,
    ...
    nodes.Iir_Kind.Reduction_And_Operator: UnaryAndExpression,
    nodes.Iir_Kind.Reduction_Nand_Operator: UnaryNandExpression,
    nodes.Iir_Kind.Reduction_Or_Operator: UnaryOrExpression,
    nodes.Iir_Kind.Reduction_Nor_Operator: UnaryNorExpression,
    nodes.Iir_Kind.Reduction_Xor_Operator: UnaryXorExpression,
    nodes.Iir_Kind.Reduction_Xnor_Operator: UnaryXnorExpression,
