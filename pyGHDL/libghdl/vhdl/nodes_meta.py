...
class fields(IntEnum):
    ...
    Conditional_Waveform_Chain = 256
    Guard_Expression = 257
    Guard_Decl = 258
    Guard_Sensitivity_List = 259
    Attribute_Implicit_Chain = 260
    Block_Block_Configuration = 261
    Package_Header = 262
    Block_Header = 263
    Uninstantiated_Package_Name = 264
    Uninstantiated_Package_Decl = 265
    Associated_Package = 266
    Instance_Source_File = 267
    Generate_Block_Configuration = 268
    Generate_Statement_Body = 269
    Alternative_Label = 270
    Generate_Else_Clause = 271
    Condition = 272
    Else_Clause = 273
    Parameter_Specification = 274
    Parent = 275
    Loop_Label = 276
    Exit_Flag = 277
    Next_Flag = 278
    Component_Name = 279
    Instantiation_List = 280
    Entity_Aspect = 281
    Default_Entity_Aspect = 282
    Binding_Indication = 283
    Named_Entity = 284
    Referenced_Name = 285
    Expr_Staticness = 286
    Scalar_Size = 287
    ...
    Unit_Name = 292
    Name = 293
    Group_Template_Name = 294
    Name_Staticness = 295
    Prefix = 296
    Signature_Prefix = 297
    External_Pathname = 298
    Pathname_Suffix = 299
    Pathname_Expression = 300
    In_Formal_Flag = 301
    Inertial_Flag = 302
    Slice_Subtype = 303
    Suffix = 304
    ...
    Parameter_4 = 309
    Attr_Chain = 310
    Attribute_Implicit_Declaration = 311
    Actual_Type = 312
    ...
    Is_Clocked_Process = 358
    Allow_Unknown_Subprogram_Body = 359
    Has_Label = 360
    Has_Begin = 361
    Has_End = 362
    Has_Is = 363
    ...
    Has_Parameter = 366
    Has_Component = 367
    Has_Identifier_List = 368
    Has_Mode = 369
    Has_Class = 370
    Has_Delay_Mechanism = 371
    Suspend_Flag = 372
    Stop_Flag = 373
    Is_Ref = 374
    Is_Forward_Ref = 375
