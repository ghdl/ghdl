...
class Iir_Kind(IntEnum):
    ...
    Null_Literal = 11
    String_Literal8 = 12
    Physical_Int_Literal = 13
    Physical_Fp_Literal = 14
    Simple_Aggregate = 15
    Overflow_Literal = 16
    Unaffected_Waveform = 17
    Waveform_Element = 18
    Conditional_Waveform = 19
    Conditional_Expression = 20
    Association_Element_By_Expression = 21
    Association_Element_By_Name = 22
    Association_Element_By_Individual = 23
    Association_Element_Open = 24
    Association_Element_Package = 25
    Association_Element_Type = 26
    Association_Element_Subprogram = 27
    Association_Element_Terminal = 28
    Choice_By_Range = 29
    Choice_By_Expression = 30
    Choice_By_Others = 31
    Choice_By_None = 32
    Choice_By_Name = 33
    Entity_Aspect_Entity = 34
    Entity_Aspect_Configuration = 35
    Entity_Aspect_Open = 36
    Psl_Hierarchical_Name = 37
    Block_Configuration = 38
    Block_Header = 39
    Component_Configuration = 40
    Binding_Indication = 41
    Entity_Class = 42
    Attribute_Value = 43
    Signature = 44
    Aggregate_Info = 45
    Procedure_Call = 46
    Record_Element_Constraint = 47
    Array_Element_Resolution = 48
    Record_Resolution = 49
    Record_Element_Resolution = 50
    Break_Element = 51
    Attribute_Specification = 52
    Disconnection_Specification = 53
    Step_Limit_Specification = 54
    Configuration_Specification = 55
    Access_Type_Definition = 56
    Incomplete_Type_Definition = 57
    Interface_Type_Definition = 58
    File_Type_Definition = 59
    Protected_Type_Declaration = 60
    Record_Type_Definition = 61
    Array_Type_Definition = 62
    Array_Subtype_Definition = 63
    Record_Subtype_Definition = 64
    Access_Subtype_Definition = 65
    ...
    Overload_List = 82
    Entity_Declaration = 83
    Configuration_Declaration = 84
    Context_Declaration = 85
    Package_Declaration = 86
    Package_Instantiation_Declaration = 87
    Vmode_Declaration = 88
    Vprop_Declaration = 89
    Vunit_Declaration = 90
    Package_Body = 91
    Architecture_Body = 92
    Type_Declaration = 93
    Anonymous_Type_Declaration = 94
    Subtype_Declaration = 95
    Nature_Declaration = 96
    Subnature_Declaration = 97
    Package_Header = 98
    Unit_Declaration = 99
    Library_Declaration = 100
    Component_Declaration = 101
    Attribute_Declaration = 102
    Group_Template_Declaration = 103
    Group_Declaration = 104
    Element_Declaration = 105
    Nature_Element_Declaration = 106
    Non_Object_Alias_Declaration = 107
    Psl_Declaration = 108
    Psl_Endpoint_Declaration = 109
    Enumeration_Literal = 110
    Function_Declaration = 111
    Procedure_Declaration = 112
    Function_Body = 113
    Procedure_Body = 114
    Function_Instantiation_Declaration = 115
    Procedure_Instantiation_Declaration = 116
    Terminal_Declaration = 117
    Object_Alias_Declaration = 118
    Free_Quantity_Declaration = 119
    Spectrum_Quantity_Declaration = 120
    Noise_Quantity_Declaration = 121
    Across_Quantity_Declaration = 122
    Through_Quantity_Declaration = 123
    File_Declaration = 124
    Guard_Signal_Declaration = 125
    Signal_Declaration = 126
    Variable_Declaration = 127
    Constant_Declaration = 128
    Iterator_Declaration = 129
    Interface_Constant_Declaration = 130
    Interface_Variable_Declaration = 131
    Interface_Signal_Declaration = 132
    Interface_File_Declaration = 133
    Interface_Quantity_Declaration = 134
    Interface_Terminal_Declaration = 135
    Interface_Type_Declaration = 136
    Interface_Package_Declaration = 137
    Interface_Function_Declaration = 138
    Interface_Procedure_Declaration = 139
