...
def _get_libghdl_name() -> Path:
    ...
    return Path(f"libghdl-{version}.{CurrentPlatform.SharedLibraryExtension}")
...
def _get_libghdl_path() -> Path:
    ...
    **Search order:**
    ...
    # TODO: replace by pyTooling code, when pyTooling gets updated to 6.2+
    def getResourceFile(module, filename: Path) -> Path:
