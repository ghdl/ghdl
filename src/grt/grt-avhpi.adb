...
package body Grt.Avhpi is
   ...
   --  unbounded (eg. array (natural range <>) of std_ulogic_vector): the
   ...
   begin
      ...
      case El_Type1.Kind is
         ...
         when Ghdl_Rtik_Type_Array =>
            --  The element's type is itself unbounded (eg. array
            --  (natural range <>) of std_ulogic_vector): its size is not
...
--                               Ghdl_Index_Type (Ghdl_B1'Pos (Vptr.B1)));
   ...
   begin
      ...
      --  unconstrained std_ulogic_vector), neither its size nor its
