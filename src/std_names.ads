...
package Std_Names is
   ...
   Name_Get_Assert_Count :      constant Name_Id := Name_First_Misc + 031;
   Name_Clear_Assert_Count :    constant Name_Id := Name_First_Misc + 032;
   Name_Step :                  constant Name_Id := Name_First_Misc + 033;
   Name_Index :                 constant Name_Id := Name_First_Misc + 034;
   Name_Item :                  constant Name_Id := Name_First_Misc + 035;
   Name_Uu_File_Uu :            constant Name_Id := Name_First_Misc + 036;
   Name_Uu_Line_Uu :            constant Name_Id := Name_First_Misc + 037;
   Name_Label_Applies_To :      constant Name_Id := Name_First_Misc + 038;
   Name_Return_Port_Name :      constant Name_Id := Name_First_Misc + 039;
   Name_Map_To_Operator :       constant Name_Id := Name_First_Misc + 040;
   Name_Type_Function :         constant Name_Id := Name_First_Misc + 041;
   Name_Built_In :              constant Name_Id := Name_First_Misc + 042;
   Name_None :                  constant Name_Id := Name_First_Misc + 043;
   ...
   Name_Realmin            : constant Name_Id := Name_First_Ieee_Name + 044;
   Name_Exp                : constant Name_Id := Name_First_Ieee_Name + 045;
   Name_Log                : constant Name_Id := Name_First_Ieee_Name + 046;
   Name_Log2               : constant Name_Id := Name_First_Ieee_Name + 047;
   Name_Log10              : constant Name_Id := Name_First_Ieee_Name + 048;
   Name_Sin                : constant Name_Id := Name_First_Ieee_Name + 049;
   Name_Cos                : constant Name_Id := Name_First_Ieee_Name + 050;
   Name_Tan                : constant Name_Id := Name_First_Ieee_Name + 051;
   Name_Arcsin             : constant Name_Id := Name_First_Ieee_Name + 052;
   Name_Arccos             : constant Name_Id := Name_First_Ieee_Name + 053;
   Name_Arctan             : constant Name_Id := Name_First_Ieee_Name + 054;
   Name_Sinh               : constant Name_Id := Name_First_Ieee_Name + 055;
   Name_Cosh               : constant Name_Id := Name_First_Ieee_Name + 056;
   Name_Tanh               : constant Name_Id := Name_First_Ieee_Name + 057;
   Name_Arcsinh            : constant Name_Id := Name_First_Ieee_Name + 058;
   Name_Arccosh            : constant Name_Id := Name_First_Ieee_Name + 059;
   Name_Arctanh            : constant Name_Id := Name_First_Ieee_Name + 060;
   Name_Sign               : constant Name_Id := Name_First_Ieee_Name + 061;
   Name_Sqrt               : constant Name_Id := Name_First_Ieee_Name + 062;
   Name_Cbrt               : constant Name_Id := Name_First_Ieee_Name + 063;
   Name_Shl                : constant Name_Id := Name_First_Ieee_Name + 064;
   Name_Shr                : constant Name_Id := Name_First_Ieee_Name + 065;
   Name_Ext                : constant Name_Id := Name_First_Ieee_Name + 066;
   Name_Sxt                : constant Name_Id := Name_First_Ieee_Name + 067;
   Name_Find_Leftmost      : constant Name_Id := Name_First_Ieee_Name + 068;
   Name_Find_Rightmost     : constant Name_Id := Name_First_Ieee_Name + 069;
   ...
   Name_Wrap               : constant Name_Id := Name_First_Synthesis + 008;
   Name_Last_Synthesis     : constant Name_Id := Name_Wrap;
