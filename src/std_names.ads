...
package Std_Names is
   ...
   Name_Arctan             : constant Name_Id := Name_First_Ieee_Name + 051;
   Name_Sinh               : constant Name_Id := Name_First_Ieee_Name + 052;
   Name_Cosh               : constant Name_Id := Name_First_Ieee_Name + 053;
   Name_Sign               : constant Name_Id := Name_First_Ieee_Name + 054;
   Name_Sqrt               : constant Name_Id := Name_First_Ieee_Name + 055;
   Name_Shl                : constant Name_Id := Name_First_Ieee_Name + 056;
   Name_Shr                : constant Name_Id := Name_First_Ieee_Name + 057;
   Name_Ext                : constant Name_Id := Name_First_Ieee_Name + 058;
   Name_Sxt                : constant Name_Id := Name_First_Ieee_Name + 059;
   Name_Find_Leftmost      : constant Name_Id := Name_First_Ieee_Name + 060;
   Name_Find_Rightmost     : constant Name_Id := Name_First_Ieee_Name + 061;
