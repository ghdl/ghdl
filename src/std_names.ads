...
package Std_Names is
   ...
   Name_Exp                : constant Name_Id := Name_First_Ieee_Name + 042;
   Name_Log                : constant Name_Id := Name_First_Ieee_Name + 043;
   Name_Log2               : constant Name_Id := Name_First_Ieee_Name + 044;
   Name_Log10              : constant Name_Id := Name_First_Ieee_Name + 045;
   Name_Sin                : constant Name_Id := Name_First_Ieee_Name + 046;
   Name_Cos                : constant Name_Id := Name_First_Ieee_Name + 047;
   Name_Arctan             : constant Name_Id := Name_First_Ieee_Name + 048;
   Name_Sinh               : constant Name_Id := Name_First_Ieee_Name + 049;
   Name_Cosh               : constant Name_Id := Name_First_Ieee_Name + 050;
   Name_Sign               : constant Name_Id := Name_First_Ieee_Name + 051;
   Name_Sqrt               : constant Name_Id := Name_First_Ieee_Name + 052;
   Name_Shl                : constant Name_Id := Name_First_Ieee_Name + 053;
   Name_Shr                : constant Name_Id := Name_First_Ieee_Name + 054;
   Name_Ext                : constant Name_Id := Name_First_Ieee_Name + 055;
   Name_Sxt                : constant Name_Id := Name_First_Ieee_Name + 056;
   Name_Find_Leftmost      : constant Name_Id := Name_First_Ieee_Name + 057;
   Name_Find_Rightmost     : constant Name_Id := Name_First_Ieee_Name + 058;
