...
// Return a unique id
#[no_mangle]
pub extern fn sintern_get_identifier_with_len(inst: &mut Interner, name: *const u8, len: u32) -> NameId {
...
#[no_mangle]
pub extern fn sintern_get_identifier_no_create_with_len(inst: &mut Interner, name: *const u8, len: u32) -> NameId {
...
#[no_mangle]
pub extern fn sintern_get_identifier_static_with_len(inst: &mut Interner, name: *const u8, len: u32) -> NameId {
...
#[no_mangle]
pub extern fn sintern_get_identifier_extra_with_len(inst: &mut Interner, name: *const u8, len: u32) -> NameId {
...
#[no_mangle]
pub extern fn sintern_get_address(inst: &Interner, id: NameId) -> *const u8 {
    inst.lookup(id).as_ptr()
}

// Get the length of the identifier (in bytes).
#[no_mangle]
pub extern fn sintern_get_length(inst: &Interner, id: NameId) -> u32 {
    inst.lookup(id).len() as u32
}

// Get the last known identifier.
#[no_mangle]
pub extern fn sintern_get_last(inst: &Interner) -> NameId {
    inst.get_last()
}

#[no_mangle]
pub extern fn sintern_get_info(inst: &mut Interner, id: NameId) -> u32 {
    inst.get_info(id)
}

#[no_mangle]
pub extern fn sintern_set_info(inst: &mut Interner, id: NameId, info: u32) {
