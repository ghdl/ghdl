...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Interface_Signal_Declaration => 1231,
      Iir_Kind_Interface_View_Declaration => 1250,
      Iir_Kind_Interface_File_Declaration => 1266,
      Iir_Kind_Interface_Quantity_Declaration => 1282,
      Iir_Kind_Interface_Terminal_Declaration => 1295,
      Iir_Kind_Interface_Type_Declaration => 1308,
      Iir_Kind_Interface_Package_Declaration => 1323,
      Iir_Kind_Interface_Function_Declaration => 1344,
      Iir_Kind_Interface_Procedure_Declaration => 1361,
      Iir_Kind_Attribute_Implicit_Declaration => 1364,
      Iir_Kind_Suspend_State_Declaration => 1368,
      Iir_Kind_Identity_Operator => 1372,
      Iir_Kind_Negation_Operator => 1376,
      Iir_Kind_Absolute_Operator => 1380,
      Iir_Kind_Not_Operator => 1384,
      Iir_Kind_Implicit_Condition_Operator => 1388,
      Iir_Kind_Condition_Operator => 1392,
      Iir_Kind_Reduction_And_Operator => 1396,
      Iir_Kind_Reduction_Or_Operator => 1400,
      Iir_Kind_Reduction_Nand_Operator => 1404,
      Iir_Kind_Reduction_Nor_Operator => 1408,
      Iir_Kind_Reduction_Xor_Operator => 1412,
      Iir_Kind_Reduction_Xnor_Operator => 1416,
      Iir_Kind_And_Operator => 1421,
      Iir_Kind_Or_Operator => 1426,
      Iir_Kind_Nand_Operator => 1431,
      Iir_Kind_Nor_Operator => 1436,
      Iir_Kind_Xor_Operator => 1441,
      Iir_Kind_Xnor_Operator => 1446,
      Iir_Kind_Equality_Operator => 1451,
      Iir_Kind_Inequality_Operator => 1456,
      Iir_Kind_Less_Than_Operator => 1461,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1466,
      Iir_Kind_Greater_Than_Operator => 1471,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1476,
      Iir_Kind_Match_Equality_Operator => 1481,
      Iir_Kind_Match_Inequality_Operator => 1486,
      Iir_Kind_Match_Less_Than_Operator => 1491,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1496,
      Iir_Kind_Match_Greater_Than_Operator => 1501,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1506,
      Iir_Kind_Sll_Operator => 1511,
      Iir_Kind_Sla_Operator => 1516,
      Iir_Kind_Srl_Operator => 1521,
      Iir_Kind_Sra_Operator => 1526,
      Iir_Kind_Rol_Operator => 1531,
      Iir_Kind_Ror_Operator => 1536,
      Iir_Kind_Addition_Operator => 1541,
      Iir_Kind_Substraction_Operator => 1546,
      Iir_Kind_Concatenation_Operator => 1551,
      Iir_Kind_Multiplication_Operator => 1556,
      Iir_Kind_Division_Operator => 1561,
      Iir_Kind_Modulus_Operator => 1566,
      Iir_Kind_Remainder_Operator => 1571,
      Iir_Kind_Exponentiation_Operator => 1576,
      Iir_Kind_Function_Call => 1584,
      Iir_Kind_Aggregate => 1592,
      Iir_Kind_Parenthesis_Expression => 1595,
      Iir_Kind_Qualified_Expression => 1599,
      Iir_Kind_Type_Conversion => 1604,
      Iir_Kind_Allocator_By_Expression => 1609,
      Iir_Kind_Allocator_By_Subtype => 1615,
      Iir_Kind_Selected_Element => 1623,
      Iir_Kind_Dereference => 1628,
      Iir_Kind_Implicit_Dereference => 1633,
      Iir_Kind_Slice_Name => 1640,
      Iir_Kind_Indexed_Name => 1646,
      Iir_Kind_Psl_Prev => 1652,
      Iir_Kind_Psl_Stable => 1657,
      Iir_Kind_Psl_Rose => 1662,
      Iir_Kind_Psl_Fell => 1667,
      Iir_Kind_Psl_Onehot => 1670,
      Iir_Kind_Psl_Onehot0 => 1673,
      Iir_Kind_Psl_Expression => 1675,
      Iir_Kind_Sensitized_Process_Statement => 1696,
      Iir_Kind_Process_Statement => 1716,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1729,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1742,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1757,
      Iir_Kind_Concurrent_Assertion_Statement => 1765,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1773,
      Iir_Kind_Concurrent_Break_Statement => 1783,
      Iir_Kind_Psl_Assert_Directive => 1797,
      Iir_Kind_Psl_Assume_Directive => 1809,
      Iir_Kind_Psl_Cover_Directive => 1822,
      Iir_Kind_Psl_Restrict_Directive => 1834,
      Iir_Kind_Block_Statement => 1848,
      Iir_Kind_If_Generate_Statement => 1859,
      Iir_Kind_Case_Generate_Statement => 1868,
      Iir_Kind_For_Generate_Statement => 1877,
      Iir_Kind_Component_Instantiation_Statement => 1889,
      Iir_Kind_Psl_Default_Clock => 1892,
      Iir_Kind_Generate_Statement_Body => 1903,
      Iir_Kind_If_Generate_Else_Clause => 1909,
      Iir_Kind_Simple_Simultaneous_Statement => 1916,
      Iir_Kind_Simultaneous_Null_Statement => 1920,
      Iir_Kind_Simultaneous_Procedural_Statement => 1931,
      Iir_Kind_Simultaneous_Case_Statement => 1940,
      Iir_Kind_Simultaneous_If_Statement => 1949,
      Iir_Kind_Simultaneous_Elsif => 1955,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1967,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1979,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1993,
      Iir_Kind_Signal_Force_Assignment_Statement => 2004,
      Iir_Kind_Signal_Release_Assignment_Statement => 2014,
      Iir_Kind_Variable_Assignment_Statement => 2022,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 2030,
      Iir_Kind_Selected_Variable_Assignment_Statement => 2040,
      Iir_Kind_Null_Statement => 2045,
      Iir_Kind_Assertion_Statement => 2053,
      Iir_Kind_Report_Statement => 2060,
      Iir_Kind_Next_Statement => 2068,
      Iir_Kind_Exit_Statement => 2076,
      Iir_Kind_Return_Statement => 2084,
      Iir_Kind_Procedure_Call_Statement => 2091,
      Iir_Kind_Wait_Statement => 2100,
      Iir_Kind_Break_Statement => 2108,
      Iir_Kind_For_Loop_Statement => 2120,
      Iir_Kind_While_Loop_Statement => 2132,
      Iir_Kind_Case_Statement => 2142,
      Iir_Kind_If_Statement => 2153,
      Iir_Kind_Suspend_State_Statement => 2159,
      Iir_Kind_Elsif => 2166,
      Iir_Kind_Character_Literal => 2173,
      Iir_Kind_Simple_Name => 2180,
      Iir_Kind_Selected_Name => 2188,
      Iir_Kind_Operator_Symbol => 2193,
      Iir_Kind_Reference_Name => 2198,
      Iir_Kind_External_Constant_Name => 2208,
      Iir_Kind_External_Signal_Name => 2222,
      Iir_Kind_External_Variable_Name => 2233,
      Iir_Kind_Selected_By_All_Name => 2239,
      Iir_Kind_Parenthesis_Name => 2245,
      Iir_Kind_Package_Pathname => 2249,
      Iir_Kind_Absolute_Pathname => 2250,
      Iir_Kind_Relative_Pathname => 2251,
      Iir_Kind_Pathname_Element => 2256,
      Iir_Kind_Box_Name => 2256,
      Iir_Kind_Base_Attribute => 2258,
      Iir_Kind_Subtype_Attribute => 2263,
      Iir_Kind_Element_Attribute => 2268,
      Iir_Kind_Across_Attribute => 2273,
      Iir_Kind_Through_Attribute => 2278,
      Iir_Kind_Nature_Reference_Attribute => 2282,
      Iir_Kind_Left_Type_Attribute => 2287,
      Iir_Kind_Right_Type_Attribute => 2292,
      Iir_Kind_High_Type_Attribute => 2297,
      Iir_Kind_Low_Type_Attribute => 2302,
      Iir_Kind_Ascending_Type_Attribute => 2307,
      Iir_Kind_Image_Attribute => 2313,
      Iir_Kind_Value_Attribute => 2319,
      Iir_Kind_Pos_Attribute => 2325,
      Iir_Kind_Val_Attribute => 2331,
      Iir_Kind_Succ_Attribute => 2337,
      Iir_Kind_Pred_Attribute => 2343,
      Iir_Kind_Leftof_Attribute => 2349,
      Iir_Kind_Rightof_Attribute => 2355,
      Iir_Kind_Signal_Slew_Attribute => 2363,
      Iir_Kind_Quantity_Slew_Attribute => 2371,
      Iir_Kind_Ramp_Attribute => 2379,
      Iir_Kind_Zoh_Attribute => 2387,
      Iir_Kind_Ltf_Attribute => 2395,
      Iir_Kind_Ztf_Attribute => 2405,
      Iir_Kind_Dot_Attribute => 2411,
      Iir_Kind_Integ_Attribute => 2417,
      Iir_Kind_Quantity_Delayed_Attribute => 2424,
      Iir_Kind_Above_Attribute => 2432,
      Iir_Kind_Delayed_Attribute => 2440,
      Iir_Kind_Stable_Attribute => 2448,
      Iir_Kind_Quiet_Attribute => 2456,
      Iir_Kind_Transaction_Attribute => 2464,
      Iir_Kind_Event_Attribute => 2468,
      Iir_Kind_Active_Attribute => 2472,
      Iir_Kind_Last_Event_Attribute => 2476,
      Iir_Kind_Last_Active_Attribute => 2480,
      Iir_Kind_Last_Value_Attribute => 2484,
      Iir_Kind_Driving_Attribute => 2488,
      Iir_Kind_Driving_Value_Attribute => 2492,
      Iir_Kind_Behavior_Attribute => 2492,
      Iir_Kind_Structure_Attribute => 2492,
      Iir_Kind_Simple_Name_Attribute => 2499,
      Iir_Kind_Instance_Name_Attribute => 2504,
      Iir_Kind_Path_Name_Attribute => 2509,
      Iir_Kind_Converse_Attribute => 2511,
      Iir_Kind_Left_Array_Attribute => 2518,
      Iir_Kind_Right_Array_Attribute => 2525,
      Iir_Kind_High_Array_Attribute => 2532,
      Iir_Kind_Low_Array_Attribute => 2539,
      Iir_Kind_Length_Array_Attribute => 2546,
      Iir_Kind_Ascending_Array_Attribute => 2553,
      Iir_Kind_Range_Array_Attribute => 2560,
      Iir_Kind_Reverse_Range_Array_Attribute => 2567,
      Iir_Kind_Attribute_Name => 2576
     );
