...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Interface_View_Declaration => 1252,
      Iir_Kind_Interface_File_Declaration => 1268,
      Iir_Kind_Interface_Quantity_Declaration => 1284,
      Iir_Kind_Interface_Terminal_Declaration => 1297,
      Iir_Kind_Interface_Type_Declaration => 1310,
      Iir_Kind_Interface_Package_Declaration => 1325,
      Iir_Kind_Interface_Function_Declaration => 1346,
