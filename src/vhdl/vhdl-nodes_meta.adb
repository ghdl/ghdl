...
package body Vhdl.Nodes_Meta is
   Fields_Type : constant array (Fields_Enum) of Types_Enum :=
     (
      ...
      Field_Has_Semicolon => Type_Boolean,
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Simple_Mode_View_Element => 272,
      Iir_Kind_Array_Mode_View_Element => 279,
      Iir_Kind_Record_Mode_View_Element => 286,
      Iir_Kind_Break_Element => 290,
      Iir_Kind_Attribute_Specification => 299,
      Iir_Kind_Disconnection_Specification => 305,
      Iir_Kind_Step_Limit_Specification => 311,
      Iir_Kind_Configuration_Specification => 318,
      Iir_Kind_Access_Type_Definition => 325,
      Iir_Kind_Incomplete_Type_Definition => 332,
      Iir_Kind_Interface_Type_Definition => 339,
      Iir_Kind_File_Type_Definition => 345,
      Iir_Kind_Protected_Type_Declaration => 356,
      Iir_Kind_Record_Type_Definition => 366,
      Iir_Kind_Array_Type_Definition => 377,
      Iir_Kind_Array_Subtype_Definition => 394,
      Iir_Kind_Record_Subtype_Definition => 407,
      Iir_Kind_Access_Subtype_Definition => 415,
      Iir_Kind_File_Subtype_Definition => 422,
      Iir_Kind_Physical_Subtype_Definition => 432,
      Iir_Kind_Floating_Subtype_Definition => 443,
      Iir_Kind_Integer_Subtype_Definition => 453,
      Iir_Kind_Enumeration_Subtype_Definition => 463,
      Iir_Kind_Enumeration_Type_Definition => 474,
      Iir_Kind_Integer_Type_Definition => 482,
      Iir_Kind_Floating_Type_Definition => 490,
      Iir_Kind_Physical_Type_Definition => 501,
      Iir_Kind_Range_Expression => 509,
      Iir_Kind_Protected_Type_Body => 517,
      Iir_Kind_Wildcard_Type_Definition => 521,
      Iir_Kind_Foreign_Vector_Type_Definition => 522,
      Iir_Kind_Subtype_Definition => 529,
      Iir_Kind_Record_Mode_View_Indication => 533,
      Iir_Kind_Array_Mode_View_Indication => 537,
      Iir_Kind_Scalar_Nature_Definition => 545,
      Iir_Kind_Record_Nature_Definition => 558,
      Iir_Kind_Array_Nature_Definition => 572,
      Iir_Kind_Array_Subnature_Definition => 587,
      Iir_Kind_Overload_List => 588,
      Iir_Kind_Foreign_Module => 593,
      Iir_Kind_Entity_Declaration => 607,
      Iir_Kind_Configuration_Declaration => 617,
      Iir_Kind_Context_Declaration => 623,
      Iir_Kind_Package_Declaration => 638,
      Iir_Kind_Package_Instantiation_Declaration => 654,
      Iir_Kind_Vmode_Declaration => 666,
      Iir_Kind_Vprop_Declaration => 678,
      Iir_Kind_Vunit_Declaration => 691,
      Iir_Kind_Package_Body => 699,
      Iir_Kind_Architecture_Body => 713,
      Iir_Kind_Package_Instantiation_Body => 721,
      Iir_Kind_Type_Declaration => 728,
      Iir_Kind_Anonymous_Type_Declaration => 734,
      Iir_Kind_Subtype_Declaration => 742,
      Iir_Kind_Nature_Declaration => 748,
      Iir_Kind_Subnature_Declaration => 755,
      Iir_Kind_Package_Header => 757,
      Iir_Kind_Unit_Declaration => 766,
      Iir_Kind_Library_Declaration => 774,
      Iir_Kind_Component_Declaration => 785,
      Iir_Kind_Attribute_Declaration => 792,
      Iir_Kind_Group_Template_Declaration => 798,
      Iir_Kind_Group_Declaration => 805,
      Iir_Kind_Element_Declaration => 813,
      Iir_Kind_Nature_Element_Declaration => 820,
      Iir_Kind_Non_Object_Alias_Declaration => 828,
      Iir_Kind_Mode_View_Declaration => 839,
      Iir_Kind_Psl_Declaration => 847,
      Iir_Kind_Psl_Boolean_Parameter => 855,
      Iir_Kind_Psl_Endpoint_Declaration => 869,
      Iir_Kind_Enumeration_Literal => 881,
      Iir_Kind_Function_Declaration => 909,
      Iir_Kind_Procedure_Declaration => 934,
      Iir_Kind_Function_Body => 944,
      Iir_Kind_Procedure_Body => 955,
      Iir_Kind_Subprogram_Instantiation_Body => 966,
      Iir_Kind_Function_Instantiation_Declaration => 984,
      Iir_Kind_Procedure_Instantiation_Declaration => 1001,
      Iir_Kind_Terminal_Declaration => 1011,
      Iir_Kind_Object_Alias_Declaration => 1024,
      Iir_Kind_Free_Quantity_Declaration => 1036,
      Iir_Kind_Spectrum_Quantity_Declaration => 1049,
      Iir_Kind_Noise_Quantity_Declaration => 1061,
      Iir_Kind_Across_Quantity_Declaration => 1077,
      Iir_Kind_Through_Quantity_Declaration => 1093,
      Iir_Kind_File_Declaration => 1108,
      Iir_Kind_Guard_Signal_Declaration => 1122,
      Iir_Kind_Signal_Declaration => 1139,
      Iir_Kind_Variable_Declaration => 1152,
      Iir_Kind_Constant_Declaration => 1167,
      Iir_Kind_Iterator_Declaration => 1179,
      Iir_Kind_Interface_Constant_Declaration => 1196,
      Iir_Kind_Interface_Variable_Declaration => 1212,
      Iir_Kind_Interface_Signal_Declaration => 1234,
      Iir_Kind_Interface_View_Declaration => 1253,
      Iir_Kind_Interface_File_Declaration => 1269,
      Iir_Kind_Interface_Quantity_Declaration => 1285,
      Iir_Kind_Interface_Terminal_Declaration => 1298,
      Iir_Kind_Interface_Type_Declaration => 1311,
      Iir_Kind_Interface_Package_Declaration => 1326,
      Iir_Kind_Interface_Function_Declaration => 1347,
      Iir_Kind_Interface_Procedure_Declaration => 1365,
      Iir_Kind_Attribute_Implicit_Declaration => 1368,
      Iir_Kind_Suspend_State_Declaration => 1372,
      Iir_Kind_Identity_Operator => 1376,
      Iir_Kind_Negation_Operator => 1380,
      Iir_Kind_Absolute_Operator => 1384,
      Iir_Kind_Not_Operator => 1388,
      Iir_Kind_Implicit_Condition_Operator => 1392,
      Iir_Kind_Condition_Operator => 1396,
      Iir_Kind_Reduction_And_Operator => 1400,
      Iir_Kind_Reduction_Or_Operator => 1404,
      Iir_Kind_Reduction_Nand_Operator => 1408,
      Iir_Kind_Reduction_Nor_Operator => 1412,
      Iir_Kind_Reduction_Xor_Operator => 1416,
      Iir_Kind_Reduction_Xnor_Operator => 1420,
      Iir_Kind_And_Operator => 1425,
      Iir_Kind_Or_Operator => 1430,
      Iir_Kind_Nand_Operator => 1435,
      Iir_Kind_Nor_Operator => 1440,
      Iir_Kind_Xor_Operator => 1445,
      Iir_Kind_Xnor_Operator => 1450,
      Iir_Kind_Equality_Operator => 1455,
      Iir_Kind_Inequality_Operator => 1460,
      Iir_Kind_Less_Than_Operator => 1465,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1470,
      Iir_Kind_Greater_Than_Operator => 1475,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1480,
      Iir_Kind_Match_Equality_Operator => 1485,
      Iir_Kind_Match_Inequality_Operator => 1490,
      Iir_Kind_Match_Less_Than_Operator => 1495,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1500,
      Iir_Kind_Match_Greater_Than_Operator => 1505,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1510,
      Iir_Kind_Sll_Operator => 1515,
      Iir_Kind_Sla_Operator => 1520,
      Iir_Kind_Srl_Operator => 1525,
      Iir_Kind_Sra_Operator => 1530,
      Iir_Kind_Rol_Operator => 1535,
      Iir_Kind_Ror_Operator => 1540,
      Iir_Kind_Addition_Operator => 1545,
      Iir_Kind_Substraction_Operator => 1550,
      Iir_Kind_Concatenation_Operator => 1555,
      Iir_Kind_Multiplication_Operator => 1560,
      Iir_Kind_Division_Operator => 1565,
      Iir_Kind_Modulus_Operator => 1570,
      Iir_Kind_Remainder_Operator => 1575,
      Iir_Kind_Exponentiation_Operator => 1580,
      Iir_Kind_Function_Call => 1588,
      Iir_Kind_Aggregate => 1596,
      Iir_Kind_Parenthesis_Expression => 1599,
      Iir_Kind_Qualified_Expression => 1603,
      Iir_Kind_Type_Conversion => 1608,
      Iir_Kind_Allocator_By_Expression => 1613,
      Iir_Kind_Allocator_By_Subtype => 1619,
      Iir_Kind_Selected_Element => 1627,
      Iir_Kind_Dereference => 1632,
      Iir_Kind_Implicit_Dereference => 1637,
      Iir_Kind_Slice_Name => 1644,
      Iir_Kind_Indexed_Name => 1650,
      Iir_Kind_Psl_Prev => 1656,
      Iir_Kind_Psl_Stable => 1661,
      Iir_Kind_Psl_Rose => 1666,
      Iir_Kind_Psl_Fell => 1671,
      Iir_Kind_Psl_Onehot => 1674,
      Iir_Kind_Psl_Onehot0 => 1677,
      Iir_Kind_Psl_Expression => 1679,
      Iir_Kind_Sensitized_Process_Statement => 1700,
      Iir_Kind_Process_Statement => 1720,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1733,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1746,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1761,
      Iir_Kind_Concurrent_Assertion_Statement => 1769,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1777,
      Iir_Kind_Concurrent_Break_Statement => 1787,
      Iir_Kind_Psl_Assert_Directive => 1801,
      Iir_Kind_Psl_Assume_Directive => 1813,
      Iir_Kind_Psl_Cover_Directive => 1826,
      Iir_Kind_Psl_Restrict_Directive => 1838,
      Iir_Kind_Block_Statement => 1852,
      Iir_Kind_If_Generate_Statement => 1863,
      Iir_Kind_Case_Generate_Statement => 1872,
      Iir_Kind_For_Generate_Statement => 1881,
      Iir_Kind_Component_Instantiation_Statement => 1893,
      Iir_Kind_Psl_Default_Clock => 1896,
      Iir_Kind_Generate_Statement_Body => 1907,
      Iir_Kind_If_Generate_Else_Clause => 1913,
      Iir_Kind_Simple_Simultaneous_Statement => 1920,
      Iir_Kind_Simultaneous_Null_Statement => 1924,
      Iir_Kind_Simultaneous_Procedural_Statement => 1935,
      Iir_Kind_Simultaneous_Case_Statement => 1944,
      Iir_Kind_Simultaneous_If_Statement => 1953,
      Iir_Kind_Simultaneous_Elsif => 1959,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1971,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1983,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1997,
      Iir_Kind_Signal_Force_Assignment_Statement => 2008,
      Iir_Kind_Signal_Release_Assignment_Statement => 2018,
      Iir_Kind_Variable_Assignment_Statement => 2026,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 2034,
      Iir_Kind_Selected_Variable_Assignment_Statement => 2044,
      Iir_Kind_Null_Statement => 2049,
      Iir_Kind_Assertion_Statement => 2057,
      Iir_Kind_Report_Statement => 2064,
      Iir_Kind_Next_Statement => 2072,
      Iir_Kind_Exit_Statement => 2080,
      Iir_Kind_Return_Statement => 2088,
      Iir_Kind_Procedure_Call_Statement => 2095,
      Iir_Kind_Wait_Statement => 2104,
      Iir_Kind_Break_Statement => 2112,
      Iir_Kind_For_Loop_Statement => 2124,
      Iir_Kind_While_Loop_Statement => 2136,
      Iir_Kind_Case_Statement => 2146,
      Iir_Kind_If_Statement => 2157,
      Iir_Kind_Suspend_State_Statement => 2163,
      Iir_Kind_Elsif => 2170,
      Iir_Kind_Character_Literal => 2177,
      Iir_Kind_Simple_Name => 2184,
      Iir_Kind_Selected_Name => 2192,
      Iir_Kind_Operator_Symbol => 2197,
      Iir_Kind_Reference_Name => 2202,
      Iir_Kind_External_Constant_Name => 2212,
      Iir_Kind_External_Signal_Name => 2226,
      Iir_Kind_External_Variable_Name => 2237,
      Iir_Kind_Selected_By_All_Name => 2243,
      Iir_Kind_Parenthesis_Name => 2249,
      Iir_Kind_Package_Pathname => 2253,
      Iir_Kind_Absolute_Pathname => 2254,
      Iir_Kind_Relative_Pathname => 2255,
      Iir_Kind_Pathname_Element => 2260,
      Iir_Kind_Box_Name => 2260,
      Iir_Kind_Base_Attribute => 2262,
      Iir_Kind_Subtype_Attribute => 2267,
      Iir_Kind_Element_Attribute => 2272,
      Iir_Kind_Across_Attribute => 2277,
      Iir_Kind_Through_Attribute => 2282,
      Iir_Kind_Nature_Reference_Attribute => 2286,
      Iir_Kind_Left_Type_Attribute => 2291,
      Iir_Kind_Right_Type_Attribute => 2296,
      Iir_Kind_High_Type_Attribute => 2301,
      Iir_Kind_Low_Type_Attribute => 2306,
      Iir_Kind_Ascending_Type_Attribute => 2311,
      Iir_Kind_Image_Attribute => 2317,
      Iir_Kind_Value_Attribute => 2323,
      Iir_Kind_Pos_Attribute => 2329,
      Iir_Kind_Val_Attribute => 2335,
      Iir_Kind_Succ_Attribute => 2341,
      Iir_Kind_Pred_Attribute => 2347,
      Iir_Kind_Leftof_Attribute => 2353,
      Iir_Kind_Rightof_Attribute => 2359,
      Iir_Kind_Signal_Slew_Attribute => 2367,
      Iir_Kind_Quantity_Slew_Attribute => 2375,
      Iir_Kind_Ramp_Attribute => 2383,
      Iir_Kind_Zoh_Attribute => 2391,
      Iir_Kind_Ltf_Attribute => 2399,
      Iir_Kind_Ztf_Attribute => 2409,
      Iir_Kind_Dot_Attribute => 2415,
      Iir_Kind_Integ_Attribute => 2421,
      Iir_Kind_Quantity_Delayed_Attribute => 2428,
      Iir_Kind_Above_Attribute => 2436,
      Iir_Kind_Delayed_Attribute => 2444,
      Iir_Kind_Stable_Attribute => 2452,
      Iir_Kind_Quiet_Attribute => 2460,
      Iir_Kind_Transaction_Attribute => 2468,
      Iir_Kind_Event_Attribute => 2472,
      Iir_Kind_Active_Attribute => 2476,
      Iir_Kind_Last_Event_Attribute => 2480,
      Iir_Kind_Last_Active_Attribute => 2484,
      Iir_Kind_Last_Value_Attribute => 2488,
      Iir_Kind_Driving_Attribute => 2492,
      Iir_Kind_Driving_Value_Attribute => 2496,
      Iir_Kind_Behavior_Attribute => 2496,
      Iir_Kind_Structure_Attribute => 2496,
      Iir_Kind_Simple_Name_Attribute => 2503,
      Iir_Kind_Instance_Name_Attribute => 2508,
      Iir_Kind_Path_Name_Attribute => 2513,
      Iir_Kind_Converse_Attribute => 2515,
      Iir_Kind_Left_Array_Attribute => 2522,
      Iir_Kind_Right_Array_Attribute => 2529,
      Iir_Kind_High_Array_Attribute => 2536,
      Iir_Kind_Low_Array_Attribute => 2543,
      Iir_Kind_Length_Array_Attribute => 2550,
      Iir_Kind_Ascending_Array_Attribute => 2557,
      Iir_Kind_Range_Array_Attribute => 2564,
      Iir_Kind_Reverse_Range_Array_Attribute => 2571,
      Iir_Kind_Attribute_Name => 2580
     );
   ...
   function Has_Has_Semicolon (K : Iir_Kind) return Boolean is
   begin
      case K is
         when Iir_Kind_Interface_Constant_Declaration
           | Iir_Kind_Interface_Variable_Declaration
