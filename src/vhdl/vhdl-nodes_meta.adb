...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Return_Statement => 2076,
      Iir_Kind_Procedure_Call_Statement => 2083,
      Iir_Kind_Wait_Statement => 2092,
      Iir_Kind_Break_Statement => 2100,
      Iir_Kind_For_Loop_Statement => 2112,
      Iir_Kind_While_Loop_Statement => 2124,
      Iir_Kind_Case_Statement => 2134,
      Iir_Kind_If_Statement => 2145,
      Iir_Kind_Suspend_State_Statement => 2151,
      Iir_Kind_Elsif => 2158,
      Iir_Kind_Character_Literal => 2165,
      Iir_Kind_Simple_Name => 2172,
      Iir_Kind_Selected_Name => 2180,
      Iir_Kind_Operator_Symbol => 2185,
      Iir_Kind_Reference_Name => 2190,
      Iir_Kind_External_Constant_Name => 2200,
      Iir_Kind_External_Signal_Name => 2214,
      Iir_Kind_External_Variable_Name => 2225,
      Iir_Kind_Selected_By_All_Name => 2231,
      Iir_Kind_Parenthesis_Name => 2237,
      Iir_Kind_Package_Pathname => 2241,
      Iir_Kind_Absolute_Pathname => 2242,
      Iir_Kind_Relative_Pathname => 2243,
      Iir_Kind_Pathname_Element => 2248,
      Iir_Kind_Box_Name => 2248,
      Iir_Kind_Base_Attribute => 2250,
      Iir_Kind_Subtype_Attribute => 2255,
      Iir_Kind_Element_Attribute => 2260,
      Iir_Kind_Across_Attribute => 2265,
      Iir_Kind_Through_Attribute => 2270,
      Iir_Kind_Nature_Reference_Attribute => 2274,
      Iir_Kind_Left_Type_Attribute => 2279,
      Iir_Kind_Right_Type_Attribute => 2284,
      Iir_Kind_High_Type_Attribute => 2289,
      Iir_Kind_Low_Type_Attribute => 2294,
      Iir_Kind_Ascending_Type_Attribute => 2299,
      Iir_Kind_Image_Attribute => 2305,
      Iir_Kind_Value_Attribute => 2311,
      Iir_Kind_Pos_Attribute => 2317,
      Iir_Kind_Val_Attribute => 2323,
      Iir_Kind_Succ_Attribute => 2329,
      Iir_Kind_Pred_Attribute => 2335,
      Iir_Kind_Leftof_Attribute => 2341,
      Iir_Kind_Rightof_Attribute => 2347,
      Iir_Kind_Signal_Slew_Attribute => 2355,
      Iir_Kind_Quantity_Slew_Attribute => 2363,
      Iir_Kind_Ramp_Attribute => 2371,
      Iir_Kind_Zoh_Attribute => 2379,
      Iir_Kind_Ltf_Attribute => 2387,
      Iir_Kind_Ztf_Attribute => 2397,
      Iir_Kind_Dot_Attribute => 2403,
      Iir_Kind_Integ_Attribute => 2409,
      Iir_Kind_Quantity_Delayed_Attribute => 2416,
      Iir_Kind_Above_Attribute => 2424,
      Iir_Kind_Delayed_Attribute => 2432,
      Iir_Kind_Stable_Attribute => 2440,
      Iir_Kind_Quiet_Attribute => 2448,
      Iir_Kind_Transaction_Attribute => 2456,
      Iir_Kind_Event_Attribute => 2460,
      Iir_Kind_Active_Attribute => 2464,
      Iir_Kind_Last_Event_Attribute => 2468,
      Iir_Kind_Last_Active_Attribute => 2472,
      Iir_Kind_Last_Value_Attribute => 2476,
      Iir_Kind_Driving_Attribute => 2480,
      Iir_Kind_Driving_Value_Attribute => 2484,
      Iir_Kind_Behavior_Attribute => 2484,
      Iir_Kind_Structure_Attribute => 2484,
      Iir_Kind_Simple_Name_Attribute => 2491,
      Iir_Kind_Instance_Name_Attribute => 2496,
      Iir_Kind_Path_Name_Attribute => 2501,
      Iir_Kind_Converse_Attribute => 2503,
      Iir_Kind_Left_Array_Attribute => 2510,
      Iir_Kind_Right_Array_Attribute => 2517,
      Iir_Kind_High_Array_Attribute => 2524,
      Iir_Kind_Low_Array_Attribute => 2531,
      Iir_Kind_Length_Array_Attribute => 2538,
      Iir_Kind_Ascending_Array_Attribute => 2545,
      Iir_Kind_Range_Array_Attribute => 2552,
      Iir_Kind_Reverse_Range_Array_Attribute => 2559,
      Iir_Kind_Attribute_Name => 2568
     );
