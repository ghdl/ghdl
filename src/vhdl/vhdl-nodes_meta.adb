...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Entity_Declaration => 602,
      Iir_Kind_Configuration_Declaration => 612,
      Iir_Kind_Context_Declaration => 618,
      Iir_Kind_Package_Declaration => 633,
      Iir_Kind_Package_Instantiation_Declaration => 649,
      Iir_Kind_Vmode_Declaration => 661,
      Iir_Kind_Vprop_Declaration => 673,
      Iir_Kind_Vunit_Declaration => 686,
      Iir_Kind_Package_Body => 694,
      Iir_Kind_Architecture_Body => 707,
      Iir_Kind_Package_Instantiation_Body => 715,
      Iir_Kind_Type_Declaration => 722,
      Iir_Kind_Anonymous_Type_Declaration => 728,
      Iir_Kind_Subtype_Declaration => 736,
      Iir_Kind_Nature_Declaration => 742,
      Iir_Kind_Subnature_Declaration => 749,
      Iir_Kind_Package_Header => 751,
      Iir_Kind_Unit_Declaration => 760,
      Iir_Kind_Library_Declaration => 768,
      Iir_Kind_Component_Declaration => 778,
      Iir_Kind_Attribute_Declaration => 785,
      Iir_Kind_Group_Template_Declaration => 791,
      Iir_Kind_Group_Declaration => 798,
      Iir_Kind_Element_Declaration => 806,
      Iir_Kind_Nature_Element_Declaration => 813,
      Iir_Kind_Non_Object_Alias_Declaration => 821,
      Iir_Kind_Mode_View_Declaration => 832,
      Iir_Kind_Psl_Declaration => 840,
      Iir_Kind_Psl_Boolean_Parameter => 848,
      Iir_Kind_Psl_Endpoint_Declaration => 862,
      Iir_Kind_Enumeration_Literal => 874,
      Iir_Kind_Function_Declaration => 901,
      Iir_Kind_Procedure_Declaration => 925,
      Iir_Kind_Function_Body => 935,
      Iir_Kind_Procedure_Body => 946,
      Iir_Kind_Function_Instantiation_Declaration => 957,
      Iir_Kind_Procedure_Instantiation_Declaration => 967,
      Iir_Kind_Terminal_Declaration => 977,
      Iir_Kind_Object_Alias_Declaration => 990,
      Iir_Kind_Free_Quantity_Declaration => 1002,
      Iir_Kind_Spectrum_Quantity_Declaration => 1015,
      Iir_Kind_Noise_Quantity_Declaration => 1027,
      Iir_Kind_Across_Quantity_Declaration => 1043,
      Iir_Kind_Through_Quantity_Declaration => 1059,
      Iir_Kind_File_Declaration => 1074,
      Iir_Kind_Guard_Signal_Declaration => 1088,
      Iir_Kind_Signal_Declaration => 1105,
      Iir_Kind_Variable_Declaration => 1118,
      Iir_Kind_Constant_Declaration => 1133,
      Iir_Kind_Iterator_Declaration => 1145,
      Iir_Kind_Interface_Constant_Declaration => 1162,
      Iir_Kind_Interface_Variable_Declaration => 1178,
      Iir_Kind_Interface_Signal_Declaration => 1199,
      Iir_Kind_Interface_View_Declaration => 1215,
      Iir_Kind_Interface_File_Declaration => 1231,
      Iir_Kind_Interface_Quantity_Declaration => 1247,
      Iir_Kind_Interface_Terminal_Declaration => 1259,
      Iir_Kind_Interface_Type_Declaration => 1271,
      Iir_Kind_Interface_Package_Declaration => 1285,
      Iir_Kind_Interface_Function_Declaration => 1305,
      Iir_Kind_Interface_Procedure_Declaration => 1321,
      Iir_Kind_Attribute_Implicit_Declaration => 1324,
      Iir_Kind_Suspend_State_Declaration => 1328,
      Iir_Kind_Identity_Operator => 1332,
      Iir_Kind_Negation_Operator => 1336,
      Iir_Kind_Absolute_Operator => 1340,
      Iir_Kind_Not_Operator => 1344,
      Iir_Kind_Implicit_Condition_Operator => 1348,
      Iir_Kind_Condition_Operator => 1352,
      Iir_Kind_Reduction_And_Operator => 1356,
      Iir_Kind_Reduction_Or_Operator => 1360,
      Iir_Kind_Reduction_Nand_Operator => 1364,
      Iir_Kind_Reduction_Nor_Operator => 1368,
      Iir_Kind_Reduction_Xor_Operator => 1372,
      Iir_Kind_Reduction_Xnor_Operator => 1376,
      Iir_Kind_And_Operator => 1381,
      Iir_Kind_Or_Operator => 1386,
      Iir_Kind_Nand_Operator => 1391,
      Iir_Kind_Nor_Operator => 1396,
      Iir_Kind_Xor_Operator => 1401,
      Iir_Kind_Xnor_Operator => 1406,
      Iir_Kind_Equality_Operator => 1411,
      Iir_Kind_Inequality_Operator => 1416,
      Iir_Kind_Less_Than_Operator => 1421,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1426,
      Iir_Kind_Greater_Than_Operator => 1431,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1436,
      Iir_Kind_Match_Equality_Operator => 1441,
      Iir_Kind_Match_Inequality_Operator => 1446,
      Iir_Kind_Match_Less_Than_Operator => 1451,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1456,
      Iir_Kind_Match_Greater_Than_Operator => 1461,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1466,
      Iir_Kind_Sll_Operator => 1471,
      Iir_Kind_Sla_Operator => 1476,
      Iir_Kind_Srl_Operator => 1481,
      Iir_Kind_Sra_Operator => 1486,
      Iir_Kind_Rol_Operator => 1491,
      Iir_Kind_Ror_Operator => 1496,
      Iir_Kind_Addition_Operator => 1501,
      Iir_Kind_Substraction_Operator => 1506,
      Iir_Kind_Concatenation_Operator => 1511,
      Iir_Kind_Multiplication_Operator => 1516,
      Iir_Kind_Division_Operator => 1521,
      Iir_Kind_Modulus_Operator => 1526,
      Iir_Kind_Remainder_Operator => 1531,
      Iir_Kind_Exponentiation_Operator => 1536,
      Iir_Kind_Function_Call => 1544,
      Iir_Kind_Aggregate => 1552,
      Iir_Kind_Parenthesis_Expression => 1555,
      Iir_Kind_Qualified_Expression => 1559,
      Iir_Kind_Type_Conversion => 1564,
      Iir_Kind_Allocator_By_Expression => 1569,
      Iir_Kind_Allocator_By_Subtype => 1575,
      Iir_Kind_Selected_Element => 1583,
      Iir_Kind_Dereference => 1588,
      Iir_Kind_Implicit_Dereference => 1593,
      Iir_Kind_Slice_Name => 1600,
      Iir_Kind_Indexed_Name => 1606,
      Iir_Kind_Psl_Prev => 1612,
      Iir_Kind_Psl_Stable => 1617,
      Iir_Kind_Psl_Rose => 1622,
      Iir_Kind_Psl_Fell => 1627,
      Iir_Kind_Psl_Onehot => 1630,
      Iir_Kind_Psl_Onehot0 => 1633,
      Iir_Kind_Psl_Expression => 1635,
      Iir_Kind_Sensitized_Process_Statement => 1657,
      ...
      Iir_Kind_Variable_Assignment_Statement => 1971,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 1978,
      Iir_Kind_Null_Statement => 1982,
      Iir_Kind_Assertion_Statement => 1989,
      Iir_Kind_Report_Statement => 1995,
      Iir_Kind_Next_Statement => 2002,
      Iir_Kind_Exit_Statement => 2009,
      Iir_Kind_Return_Statement => 2015,
      Iir_Kind_Procedure_Call_Statement => 2021,
      Iir_Kind_Wait_Statement => 2029,
      Iir_Kind_Break_Statement => 2036,
      Iir_Kind_For_Loop_Statement => 2047,
      Iir_Kind_While_Loop_Statement => 2058,
      Iir_Kind_Case_Statement => 2067,
