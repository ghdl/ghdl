...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Interface_Procedure_Declaration => 1364,
      Iir_Kind_Attribute_Implicit_Declaration => 1367,
      Iir_Kind_Suspend_State_Declaration => 1371,
      Iir_Kind_Identity_Operator => 1375,
      Iir_Kind_Negation_Operator => 1379,
      Iir_Kind_Absolute_Operator => 1383,
      Iir_Kind_Not_Operator => 1387,
      Iir_Kind_Implicit_Condition_Operator => 1391,
      Iir_Kind_Condition_Operator => 1395,
      Iir_Kind_Reduction_And_Operator => 1399,
      Iir_Kind_Reduction_Or_Operator => 1403,
      Iir_Kind_Reduction_Nand_Operator => 1407,
      Iir_Kind_Reduction_Nor_Operator => 1411,
      Iir_Kind_Reduction_Xor_Operator => 1415,
      Iir_Kind_Reduction_Xnor_Operator => 1419,
      Iir_Kind_And_Operator => 1424,
      Iir_Kind_Or_Operator => 1429,
      Iir_Kind_Nand_Operator => 1434,
      Iir_Kind_Nor_Operator => 1439,
      Iir_Kind_Xor_Operator => 1444,
      Iir_Kind_Xnor_Operator => 1449,
      Iir_Kind_Equality_Operator => 1454,
      Iir_Kind_Inequality_Operator => 1459,
      Iir_Kind_Less_Than_Operator => 1464,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1469,
      Iir_Kind_Greater_Than_Operator => 1474,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1479,
      Iir_Kind_Match_Equality_Operator => 1484,
      Iir_Kind_Match_Inequality_Operator => 1489,
      Iir_Kind_Match_Less_Than_Operator => 1494,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1499,
      Iir_Kind_Match_Greater_Than_Operator => 1504,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1509,
      Iir_Kind_Sll_Operator => 1514,
      Iir_Kind_Sla_Operator => 1519,
      Iir_Kind_Srl_Operator => 1524,
      Iir_Kind_Sra_Operator => 1529,
      Iir_Kind_Rol_Operator => 1534,
      Iir_Kind_Ror_Operator => 1539,
      Iir_Kind_Addition_Operator => 1544,
      Iir_Kind_Substraction_Operator => 1549,
      Iir_Kind_Concatenation_Operator => 1554,
      Iir_Kind_Multiplication_Operator => 1559,
      Iir_Kind_Division_Operator => 1564,
      Iir_Kind_Modulus_Operator => 1569,
      Iir_Kind_Remainder_Operator => 1574,
      Iir_Kind_Exponentiation_Operator => 1579,
      Iir_Kind_Function_Call => 1587,
      Iir_Kind_Aggregate => 1595,
      Iir_Kind_Parenthesis_Expression => 1598,
      Iir_Kind_Qualified_Expression => 1602,
      Iir_Kind_Type_Conversion => 1607,
      Iir_Kind_Allocator_By_Expression => 1612,
      Iir_Kind_Allocator_By_Subtype => 1618,
      Iir_Kind_Selected_Element => 1626,
      Iir_Kind_Dereference => 1631,
      Iir_Kind_Implicit_Dereference => 1636,
      Iir_Kind_Slice_Name => 1643,
      Iir_Kind_Indexed_Name => 1649,
      Iir_Kind_Psl_Prev => 1655,
      Iir_Kind_Psl_Stable => 1660,
      Iir_Kind_Psl_Rose => 1665,
      Iir_Kind_Psl_Fell => 1670,
      Iir_Kind_Psl_Onehot => 1673,
      Iir_Kind_Psl_Onehot0 => 1676,
      Iir_Kind_Psl_Expression => 1678,
      Iir_Kind_Sensitized_Process_Statement => 1699,
      Iir_Kind_Process_Statement => 1719,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1732,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1745,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1760,
      Iir_Kind_Concurrent_Assertion_Statement => 1768,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1776,
      Iir_Kind_Concurrent_Break_Statement => 1786,
      Iir_Kind_Psl_Assert_Directive => 1800,
      Iir_Kind_Psl_Assume_Directive => 1812,
      Iir_Kind_Psl_Cover_Directive => 1825,
      Iir_Kind_Psl_Restrict_Directive => 1837,
      Iir_Kind_Block_Statement => 1851,
      Iir_Kind_If_Generate_Statement => 1862,
      Iir_Kind_Case_Generate_Statement => 1871,
      Iir_Kind_For_Generate_Statement => 1880,
      Iir_Kind_Component_Instantiation_Statement => 1892,
      Iir_Kind_Psl_Default_Clock => 1895,
      Iir_Kind_Generate_Statement_Body => 1906,
      Iir_Kind_If_Generate_Else_Clause => 1912,
      Iir_Kind_Simple_Simultaneous_Statement => 1919,
      Iir_Kind_Simultaneous_Null_Statement => 1923,
      Iir_Kind_Simultaneous_Procedural_Statement => 1934,
      Iir_Kind_Simultaneous_Case_Statement => 1943,
      Iir_Kind_Simultaneous_If_Statement => 1952,
      Iir_Kind_Simultaneous_Elsif => 1958,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1970,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1982,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1996,
      Iir_Kind_Signal_Force_Assignment_Statement => 2007,
      Iir_Kind_Signal_Release_Assignment_Statement => 2017,
      Iir_Kind_Variable_Assignment_Statement => 2025,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 2033,
      Iir_Kind_Selected_Variable_Assignment_Statement => 2043,
      Iir_Kind_Null_Statement => 2048,
      Iir_Kind_Assertion_Statement => 2056,
      Iir_Kind_Report_Statement => 2063,
      Iir_Kind_Next_Statement => 2071,
      Iir_Kind_Exit_Statement => 2079,
      Iir_Kind_Return_Statement => 2087,
      Iir_Kind_Procedure_Call_Statement => 2094,
      Iir_Kind_Wait_Statement => 2103,
      Iir_Kind_Break_Statement => 2111,
      Iir_Kind_For_Loop_Statement => 2123,
      Iir_Kind_While_Loop_Statement => 2135,
      Iir_Kind_Case_Statement => 2145,
      Iir_Kind_If_Statement => 2156,
      Iir_Kind_Suspend_State_Statement => 2162,
      Iir_Kind_Elsif => 2169,
      Iir_Kind_Character_Literal => 2176,
      Iir_Kind_Simple_Name => 2183,
      Iir_Kind_Selected_Name => 2191,
      Iir_Kind_Operator_Symbol => 2196,
      Iir_Kind_Reference_Name => 2201,
      Iir_Kind_External_Constant_Name => 2211,
      Iir_Kind_External_Signal_Name => 2225,
      Iir_Kind_External_Variable_Name => 2236,
      Iir_Kind_Selected_By_All_Name => 2242,
      Iir_Kind_Parenthesis_Name => 2248,
      Iir_Kind_Package_Pathname => 2252,
      Iir_Kind_Absolute_Pathname => 2253,
      Iir_Kind_Relative_Pathname => 2254,
      Iir_Kind_Pathname_Element => 2259,
      Iir_Kind_Box_Name => 2259,
      Iir_Kind_Base_Attribute => 2261,
      Iir_Kind_Subtype_Attribute => 2266,
      Iir_Kind_Element_Attribute => 2271,
      Iir_Kind_Across_Attribute => 2276,
      Iir_Kind_Through_Attribute => 2281,
      Iir_Kind_Nature_Reference_Attribute => 2285,
      Iir_Kind_Left_Type_Attribute => 2290,
      Iir_Kind_Right_Type_Attribute => 2295,
      Iir_Kind_High_Type_Attribute => 2300,
      Iir_Kind_Low_Type_Attribute => 2305,
      Iir_Kind_Ascending_Type_Attribute => 2310,
      Iir_Kind_Image_Attribute => 2316,
      Iir_Kind_Value_Attribute => 2322,
      Iir_Kind_Pos_Attribute => 2328,
      Iir_Kind_Val_Attribute => 2334,
      Iir_Kind_Succ_Attribute => 2340,
      Iir_Kind_Pred_Attribute => 2346,
      Iir_Kind_Leftof_Attribute => 2352,
      Iir_Kind_Rightof_Attribute => 2358,
      Iir_Kind_Signal_Slew_Attribute => 2366,
      Iir_Kind_Quantity_Slew_Attribute => 2374,
      Iir_Kind_Ramp_Attribute => 2382,
      Iir_Kind_Zoh_Attribute => 2390,
      Iir_Kind_Ltf_Attribute => 2398,
      Iir_Kind_Ztf_Attribute => 2408,
      Iir_Kind_Dot_Attribute => 2414,
      Iir_Kind_Integ_Attribute => 2420,
      Iir_Kind_Quantity_Delayed_Attribute => 2427,
      Iir_Kind_Above_Attribute => 2435,
      Iir_Kind_Delayed_Attribute => 2443,
      Iir_Kind_Stable_Attribute => 2451,
      Iir_Kind_Quiet_Attribute => 2459,
      Iir_Kind_Transaction_Attribute => 2467,
      Iir_Kind_Event_Attribute => 2471,
      Iir_Kind_Active_Attribute => 2475,
      Iir_Kind_Last_Event_Attribute => 2479,
      Iir_Kind_Last_Active_Attribute => 2483,
      Iir_Kind_Last_Value_Attribute => 2487,
      Iir_Kind_Driving_Attribute => 2491,
      Iir_Kind_Driving_Value_Attribute => 2495,
      Iir_Kind_Behavior_Attribute => 2495,
      Iir_Kind_Structure_Attribute => 2495,
      Iir_Kind_Simple_Name_Attribute => 2502,
      Iir_Kind_Instance_Name_Attribute => 2507,
      Iir_Kind_Path_Name_Attribute => 2512,
      Iir_Kind_Converse_Attribute => 2514,
      Iir_Kind_Left_Array_Attribute => 2521,
      Iir_Kind_Right_Array_Attribute => 2528,
      Iir_Kind_High_Array_Attribute => 2535,
      Iir_Kind_Low_Array_Attribute => 2542,
      Iir_Kind_Length_Array_Attribute => 2549,
      Iir_Kind_Ascending_Array_Attribute => 2556,
      Iir_Kind_Range_Array_Attribute => 2563,
      Iir_Kind_Reverse_Range_Array_Attribute => 2570,
      Iir_Kind_Attribute_Name => 2579
     );
