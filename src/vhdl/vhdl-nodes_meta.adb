...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Process_Statement => 1682,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1695,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1708,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1722,
      Iir_Kind_Concurrent_Assertion_Statement => 1730,
      ...
      Iir_Kind_Simple_Signal_Assignment_Statement => 1927,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1938,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1950,
      Iir_Kind_Signal_Force_Assignment_Statement => 1960,
      Iir_Kind_Signal_Release_Assignment_Statement => 1969,
      Iir_Kind_Variable_Assignment_Statement => 1976,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 1983,
      Iir_Kind_Null_Statement => 1987,
      Iir_Kind_Assertion_Statement => 1994,
      Iir_Kind_Report_Statement => 2000,
      Iir_Kind_Next_Statement => 2007,
      Iir_Kind_Exit_Statement => 2014,
      Iir_Kind_Return_Statement => 2020,
      Iir_Kind_Procedure_Call_Statement => 2026,
      Iir_Kind_Wait_Statement => 2034,
      Iir_Kind_Break_Statement => 2041,
      Iir_Kind_For_Loop_Statement => 2052,
      Iir_Kind_While_Loop_Statement => 2063,
      Iir_Kind_Case_Statement => 2072,
      Iir_Kind_If_Statement => 2082,
      Iir_Kind_Suspend_State_Statement => 2087,
      Iir_Kind_Elsif => 2093,
      Iir_Kind_Character_Literal => 2100,
      Iir_Kind_Simple_Name => 2107,
      Iir_Kind_Selected_Name => 2115,
      Iir_Kind_Operator_Symbol => 2120,
      Iir_Kind_Reference_Name => 2125,
      Iir_Kind_External_Constant_Name => 2134,
      Iir_Kind_External_Signal_Name => 2144,
      Iir_Kind_External_Variable_Name => 2154,
      Iir_Kind_Selected_By_All_Name => 2160,
      Iir_Kind_Parenthesis_Name => 2166,
      Iir_Kind_Package_Pathname => 2170,
      Iir_Kind_Absolute_Pathname => 2171,
      Iir_Kind_Relative_Pathname => 2172,
      Iir_Kind_Pathname_Element => 2177,
      Iir_Kind_Base_Attribute => 2179,
      Iir_Kind_Subtype_Attribute => 2184,
      Iir_Kind_Element_Attribute => 2189,
      Iir_Kind_Across_Attribute => 2194,
      Iir_Kind_Through_Attribute => 2199,
      Iir_Kind_Nature_Reference_Attribute => 2203,
      Iir_Kind_Left_Type_Attribute => 2208,
      Iir_Kind_Right_Type_Attribute => 2213,
      Iir_Kind_High_Type_Attribute => 2218,
      Iir_Kind_Low_Type_Attribute => 2223,
      Iir_Kind_Ascending_Type_Attribute => 2228,
      Iir_Kind_Image_Attribute => 2234,
      Iir_Kind_Value_Attribute => 2240,
      Iir_Kind_Pos_Attribute => 2246,
      Iir_Kind_Val_Attribute => 2252,
      Iir_Kind_Succ_Attribute => 2258,
      Iir_Kind_Pred_Attribute => 2264,
      Iir_Kind_Leftof_Attribute => 2270,
      Iir_Kind_Rightof_Attribute => 2276,
      Iir_Kind_Signal_Slew_Attribute => 2284,
      Iir_Kind_Quantity_Slew_Attribute => 2292,
      Iir_Kind_Ramp_Attribute => 2300,
      Iir_Kind_Zoh_Attribute => 2308,
      Iir_Kind_Ltf_Attribute => 2316,
      Iir_Kind_Ztf_Attribute => 2326,
      Iir_Kind_Dot_Attribute => 2333,
      Iir_Kind_Integ_Attribute => 2340,
      Iir_Kind_Quantity_Delayed_Attribute => 2348,
      Iir_Kind_Above_Attribute => 2356,
      Iir_Kind_Delayed_Attribute => 2365,
      Iir_Kind_Stable_Attribute => 2374,
      Iir_Kind_Quiet_Attribute => 2383,
      Iir_Kind_Transaction_Attribute => 2392,
      Iir_Kind_Event_Attribute => 2396,
      Iir_Kind_Active_Attribute => 2400,
      Iir_Kind_Last_Event_Attribute => 2404,
      Iir_Kind_Last_Active_Attribute => 2408,
      Iir_Kind_Last_Value_Attribute => 2412,
      Iir_Kind_Driving_Attribute => 2416,
      Iir_Kind_Driving_Value_Attribute => 2420,
      Iir_Kind_Behavior_Attribute => 2420,
      Iir_Kind_Structure_Attribute => 2420,
      Iir_Kind_Simple_Name_Attribute => 2427,
      Iir_Kind_Instance_Name_Attribute => 2432,
      Iir_Kind_Path_Name_Attribute => 2437,
      Iir_Kind_Converse_Attribute => 2439,
      Iir_Kind_Left_Array_Attribute => 2446,
      Iir_Kind_Right_Array_Attribute => 2453,
      Iir_Kind_High_Array_Attribute => 2460,
      Iir_Kind_Low_Array_Attribute => 2467,
      Iir_Kind_Length_Array_Attribute => 2474,
      Iir_Kind_Ascending_Array_Attribute => 2481,
      Iir_Kind_Range_Array_Attribute => 2488,
      Iir_Kind_Reverse_Range_Array_Attribute => 2495,
      Iir_Kind_Attribute_Name => 2504
     );
