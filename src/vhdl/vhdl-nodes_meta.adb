...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Function_Declaration => 908,
      Iir_Kind_Procedure_Declaration => 933,
      Iir_Kind_Function_Body => 943,
      Iir_Kind_Procedure_Body => 954,
      Iir_Kind_Subprogram_Instantiation_Body => 965,
      Iir_Kind_Function_Instantiation_Declaration => 983,
      Iir_Kind_Procedure_Instantiation_Declaration => 1000,
      Iir_Kind_Terminal_Declaration => 1010,
      Iir_Kind_Object_Alias_Declaration => 1023,
      Iir_Kind_Free_Quantity_Declaration => 1035,
      Iir_Kind_Spectrum_Quantity_Declaration => 1048,
      Iir_Kind_Noise_Quantity_Declaration => 1060,
      Iir_Kind_Across_Quantity_Declaration => 1076,
      Iir_Kind_Through_Quantity_Declaration => 1092,
      Iir_Kind_File_Declaration => 1107,
      Iir_Kind_Guard_Signal_Declaration => 1121,
      Iir_Kind_Signal_Declaration => 1138,
      Iir_Kind_Variable_Declaration => 1151,
      Iir_Kind_Constant_Declaration => 1166,
      Iir_Kind_Iterator_Declaration => 1178,
      Iir_Kind_Interface_Constant_Declaration => 1195,
      Iir_Kind_Interface_Variable_Declaration => 1211,
      Iir_Kind_Interface_Signal_Declaration => 1233,
      Iir_Kind_Interface_View_Declaration => 1251,
      Iir_Kind_Interface_File_Declaration => 1267,
      Iir_Kind_Interface_Quantity_Declaration => 1283,
      Iir_Kind_Interface_Terminal_Declaration => 1296,
      Iir_Kind_Interface_Type_Declaration => 1309,
      Iir_Kind_Interface_Package_Declaration => 1324,
      Iir_Kind_Interface_Function_Declaration => 1345,
      Iir_Kind_Interface_Procedure_Declaration => 1363,
      Iir_Kind_Attribute_Implicit_Declaration => 1366,
      Iir_Kind_Suspend_State_Declaration => 1370,
      Iir_Kind_Identity_Operator => 1374,
      Iir_Kind_Negation_Operator => 1378,
      Iir_Kind_Absolute_Operator => 1382,
      Iir_Kind_Not_Operator => 1386,
      Iir_Kind_Implicit_Condition_Operator => 1390,
      Iir_Kind_Condition_Operator => 1394,
      Iir_Kind_Reduction_And_Operator => 1398,
      Iir_Kind_Reduction_Or_Operator => 1402,
      Iir_Kind_Reduction_Nand_Operator => 1406,
      Iir_Kind_Reduction_Nor_Operator => 1410,
      Iir_Kind_Reduction_Xor_Operator => 1414,
      Iir_Kind_Reduction_Xnor_Operator => 1418,
      Iir_Kind_And_Operator => 1423,
      Iir_Kind_Or_Operator => 1428,
      Iir_Kind_Nand_Operator => 1433,
      Iir_Kind_Nor_Operator => 1438,
      Iir_Kind_Xor_Operator => 1443,
      Iir_Kind_Xnor_Operator => 1448,
      Iir_Kind_Equality_Operator => 1453,
      Iir_Kind_Inequality_Operator => 1458,
      Iir_Kind_Less_Than_Operator => 1463,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1468,
      Iir_Kind_Greater_Than_Operator => 1473,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1478,
      Iir_Kind_Match_Equality_Operator => 1483,
      Iir_Kind_Match_Inequality_Operator => 1488,
      Iir_Kind_Match_Less_Than_Operator => 1493,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1498,
      Iir_Kind_Match_Greater_Than_Operator => 1503,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1508,
      Iir_Kind_Sll_Operator => 1513,
      Iir_Kind_Sla_Operator => 1518,
      Iir_Kind_Srl_Operator => 1523,
      Iir_Kind_Sra_Operator => 1528,
      Iir_Kind_Rol_Operator => 1533,
      Iir_Kind_Ror_Operator => 1538,
      Iir_Kind_Addition_Operator => 1543,
      Iir_Kind_Substraction_Operator => 1548,
      Iir_Kind_Concatenation_Operator => 1553,
      Iir_Kind_Multiplication_Operator => 1558,
      Iir_Kind_Division_Operator => 1563,
      Iir_Kind_Modulus_Operator => 1568,
      Iir_Kind_Remainder_Operator => 1573,
      Iir_Kind_Exponentiation_Operator => 1578,
      Iir_Kind_Function_Call => 1586,
      Iir_Kind_Aggregate => 1594,
      Iir_Kind_Parenthesis_Expression => 1597,
      Iir_Kind_Qualified_Expression => 1601,
      Iir_Kind_Type_Conversion => 1606,
      Iir_Kind_Allocator_By_Expression => 1611,
      Iir_Kind_Allocator_By_Subtype => 1617,
      Iir_Kind_Selected_Element => 1625,
      Iir_Kind_Dereference => 1630,
      Iir_Kind_Implicit_Dereference => 1635,
      Iir_Kind_Slice_Name => 1642,
      Iir_Kind_Indexed_Name => 1648,
      Iir_Kind_Psl_Prev => 1654,
      Iir_Kind_Psl_Stable => 1659,
      Iir_Kind_Psl_Rose => 1664,
      Iir_Kind_Psl_Fell => 1669,
      Iir_Kind_Psl_Onehot => 1672,
      Iir_Kind_Psl_Onehot0 => 1675,
      Iir_Kind_Psl_Expression => 1677,
      Iir_Kind_Sensitized_Process_Statement => 1698,
      Iir_Kind_Process_Statement => 1718,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1731,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1744,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1759,
      Iir_Kind_Concurrent_Assertion_Statement => 1767,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1775,
      Iir_Kind_Concurrent_Break_Statement => 1785,
      Iir_Kind_Psl_Assert_Directive => 1799,
      Iir_Kind_Psl_Assume_Directive => 1811,
      Iir_Kind_Psl_Cover_Directive => 1824,
      Iir_Kind_Psl_Restrict_Directive => 1836,
      Iir_Kind_Block_Statement => 1850,
      Iir_Kind_If_Generate_Statement => 1861,
      Iir_Kind_Case_Generate_Statement => 1870,
      Iir_Kind_For_Generate_Statement => 1879,
      Iir_Kind_Component_Instantiation_Statement => 1891,
      Iir_Kind_Psl_Default_Clock => 1894,
      Iir_Kind_Generate_Statement_Body => 1905,
      Iir_Kind_If_Generate_Else_Clause => 1911,
      Iir_Kind_Simple_Simultaneous_Statement => 1918,
      Iir_Kind_Simultaneous_Null_Statement => 1922,
      Iir_Kind_Simultaneous_Procedural_Statement => 1933,
      Iir_Kind_Simultaneous_Case_Statement => 1942,
      Iir_Kind_Simultaneous_If_Statement => 1951,
      Iir_Kind_Simultaneous_Elsif => 1957,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1969,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1981,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1995,
      Iir_Kind_Signal_Force_Assignment_Statement => 2006,
      Iir_Kind_Signal_Release_Assignment_Statement => 2016,
      Iir_Kind_Variable_Assignment_Statement => 2024,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 2032,
      Iir_Kind_Selected_Variable_Assignment_Statement => 2042,
      Iir_Kind_Null_Statement => 2047,
      Iir_Kind_Assertion_Statement => 2055,
      Iir_Kind_Report_Statement => 2062,
      Iir_Kind_Next_Statement => 2070,
      Iir_Kind_Exit_Statement => 2078,
      Iir_Kind_Return_Statement => 2086,
      Iir_Kind_Procedure_Call_Statement => 2093,
      Iir_Kind_Wait_Statement => 2102,
      Iir_Kind_Break_Statement => 2110,
      Iir_Kind_For_Loop_Statement => 2122,
      Iir_Kind_While_Loop_Statement => 2134,
      Iir_Kind_Case_Statement => 2144,
      Iir_Kind_If_Statement => 2155,
      Iir_Kind_Suspend_State_Statement => 2161,
      Iir_Kind_Elsif => 2168,
      Iir_Kind_Character_Literal => 2175,
      Iir_Kind_Simple_Name => 2182,
      Iir_Kind_Selected_Name => 2190,
      Iir_Kind_Operator_Symbol => 2195,
      Iir_Kind_Reference_Name => 2200,
      Iir_Kind_External_Constant_Name => 2210,
      Iir_Kind_External_Signal_Name => 2224,
      Iir_Kind_External_Variable_Name => 2235,
      Iir_Kind_Selected_By_All_Name => 2241,
      Iir_Kind_Parenthesis_Name => 2247,
      Iir_Kind_Package_Pathname => 2251,
      Iir_Kind_Absolute_Pathname => 2252,
      Iir_Kind_Relative_Pathname => 2253,
      Iir_Kind_Pathname_Element => 2258,
      Iir_Kind_Box_Name => 2258,
      Iir_Kind_Base_Attribute => 2263,
      Iir_Kind_Subtype_Attribute => 2268,
      Iir_Kind_Element_Attribute => 2273,
      Iir_Kind_Across_Attribute => 2278,
      Iir_Kind_Through_Attribute => 2283,
      Iir_Kind_Nature_Reference_Attribute => 2287,
      Iir_Kind_Left_Type_Attribute => 2292,
      Iir_Kind_Right_Type_Attribute => 2297,
      Iir_Kind_High_Type_Attribute => 2302,
      Iir_Kind_Low_Type_Attribute => 2307,
      Iir_Kind_Ascending_Type_Attribute => 2312,
      Iir_Kind_Image_Attribute => 2318,
      Iir_Kind_Value_Attribute => 2324,
      Iir_Kind_Pos_Attribute => 2330,
      Iir_Kind_Val_Attribute => 2336,
      Iir_Kind_Succ_Attribute => 2342,
      Iir_Kind_Pred_Attribute => 2348,
      Iir_Kind_Leftof_Attribute => 2354,
      Iir_Kind_Rightof_Attribute => 2360,
      Iir_Kind_Signal_Slew_Attribute => 2368,
      Iir_Kind_Quantity_Slew_Attribute => 2376,
      Iir_Kind_Ramp_Attribute => 2384,
      Iir_Kind_Zoh_Attribute => 2392,
      Iir_Kind_Ltf_Attribute => 2400,
      Iir_Kind_Ztf_Attribute => 2410,
      Iir_Kind_Dot_Attribute => 2416,
      Iir_Kind_Integ_Attribute => 2422,
      Iir_Kind_Quantity_Delayed_Attribute => 2429,
      Iir_Kind_Above_Attribute => 2437,
      Iir_Kind_Delayed_Attribute => 2445,
      Iir_Kind_Stable_Attribute => 2453,
      Iir_Kind_Quiet_Attribute => 2461,
      Iir_Kind_Transaction_Attribute => 2469,
      Iir_Kind_Event_Attribute => 2473,
      Iir_Kind_Active_Attribute => 2477,
      Iir_Kind_Last_Event_Attribute => 2481,
      Iir_Kind_Last_Active_Attribute => 2485,
      Iir_Kind_Last_Value_Attribute => 2489,
      Iir_Kind_Driving_Attribute => 2493,
      Iir_Kind_Driving_Value_Attribute => 2497,
      Iir_Kind_Behavior_Attribute => 2497,
      Iir_Kind_Structure_Attribute => 2497,
      Iir_Kind_Simple_Name_Attribute => 2504,
      Iir_Kind_Instance_Name_Attribute => 2509,
      Iir_Kind_Path_Name_Attribute => 2514,
      Iir_Kind_Converse_Attribute => 2516,
      Iir_Kind_Left_Array_Attribute => 2523,
      Iir_Kind_Right_Array_Attribute => 2530,
      Iir_Kind_High_Array_Attribute => 2537,
      Iir_Kind_Low_Array_Attribute => 2544,
      Iir_Kind_Length_Array_Attribute => 2551,
      Iir_Kind_Ascending_Array_Attribute => 2558,
      Iir_Kind_Range_Array_Attribute => 2565,
      Iir_Kind_Reverse_Range_Array_Attribute => 2572,
      Iir_Kind_Attribute_Name => 2581
     );
