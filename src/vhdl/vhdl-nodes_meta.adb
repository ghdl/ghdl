...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Concurrent_Break_Statement => 1742,
      Iir_Kind_Psl_Assert_Directive => 1756,
      Iir_Kind_Psl_Assume_Directive => 1768,
      Iir_Kind_Psl_Cover_Directive => 1780,
      Iir_Kind_Psl_Restrict_Directive => 1791,
      Iir_Kind_Block_Statement => 1805,
      Iir_Kind_If_Generate_Statement => 1816,
      Iir_Kind_Case_Generate_Statement => 1825,
      Iir_Kind_For_Generate_Statement => 1834,
      Iir_Kind_Component_Instantiation_Statement => 1846,
      Iir_Kind_Psl_Default_Clock => 1849,
      Iir_Kind_Generate_Statement_Body => 1860,
      Iir_Kind_If_Generate_Else_Clause => 1866,
      Iir_Kind_Simple_Simultaneous_Statement => 1873,
      Iir_Kind_Simultaneous_Null_Statement => 1877,
      Iir_Kind_Simultaneous_Procedural_Statement => 1888,
      Iir_Kind_Simultaneous_Case_Statement => 1897,
      Iir_Kind_Simultaneous_If_Statement => 1906,
      Iir_Kind_Simultaneous_Elsif => 1912,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1923,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1934,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1946,
      Iir_Kind_Signal_Force_Assignment_Statement => 1956,
      Iir_Kind_Signal_Release_Assignment_Statement => 1965,
      Iir_Kind_Variable_Assignment_Statement => 1972,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 1979,
      Iir_Kind_Null_Statement => 1983,
      Iir_Kind_Assertion_Statement => 1990,
      Iir_Kind_Report_Statement => 1996,
      Iir_Kind_Next_Statement => 2003,
      Iir_Kind_Exit_Statement => 2010,
      Iir_Kind_Return_Statement => 2016,
      Iir_Kind_Procedure_Call_Statement => 2022,
      Iir_Kind_Wait_Statement => 2030,
      Iir_Kind_Break_Statement => 2037,
      Iir_Kind_For_Loop_Statement => 2048,
      Iir_Kind_While_Loop_Statement => 2059,
      Iir_Kind_Case_Statement => 2068,
      Iir_Kind_If_Statement => 2078,
      Iir_Kind_Suspend_State_Statement => 2083,
      Iir_Kind_Elsif => 2089,
      Iir_Kind_Character_Literal => 2096,
      Iir_Kind_Simple_Name => 2103,
      Iir_Kind_Selected_Name => 2111,
      Iir_Kind_Operator_Symbol => 2116,
      Iir_Kind_Reference_Name => 2121,
      Iir_Kind_External_Constant_Name => 2130,
      Iir_Kind_External_Signal_Name => 2140,
      Iir_Kind_External_Variable_Name => 2150,
      Iir_Kind_Selected_By_All_Name => 2156,
      Iir_Kind_Parenthesis_Name => 2162,
      Iir_Kind_Package_Pathname => 2166,
      Iir_Kind_Absolute_Pathname => 2167,
      Iir_Kind_Relative_Pathname => 2168,
      Iir_Kind_Pathname_Element => 2173,
      Iir_Kind_Base_Attribute => 2175,
      Iir_Kind_Subtype_Attribute => 2180,
      Iir_Kind_Element_Attribute => 2185,
      Iir_Kind_Across_Attribute => 2190,
      Iir_Kind_Through_Attribute => 2195,
      Iir_Kind_Nature_Reference_Attribute => 2199,
      Iir_Kind_Left_Type_Attribute => 2204,
      Iir_Kind_Right_Type_Attribute => 2209,
      Iir_Kind_High_Type_Attribute => 2214,
      Iir_Kind_Low_Type_Attribute => 2219,
      Iir_Kind_Ascending_Type_Attribute => 2224,
      Iir_Kind_Image_Attribute => 2230,
      Iir_Kind_Value_Attribute => 2236,
      Iir_Kind_Pos_Attribute => 2242,
      Iir_Kind_Val_Attribute => 2248,
      Iir_Kind_Succ_Attribute => 2254,
      Iir_Kind_Pred_Attribute => 2260,
      Iir_Kind_Leftof_Attribute => 2266,
      Iir_Kind_Rightof_Attribute => 2272,
      Iir_Kind_Signal_Slew_Attribute => 2280,
      Iir_Kind_Quantity_Slew_Attribute => 2288,
      Iir_Kind_Ramp_Attribute => 2296,
      Iir_Kind_Zoh_Attribute => 2304,
      Iir_Kind_Ltf_Attribute => 2312,
      Iir_Kind_Ztf_Attribute => 2322,
