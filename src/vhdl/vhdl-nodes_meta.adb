...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Concurrent_Break_Statement => 1745,
      Iir_Kind_Psl_Assert_Directive => 1759,
      Iir_Kind_Psl_Assume_Directive => 1771,
      Iir_Kind_Psl_Cover_Directive => 1783,
      Iir_Kind_Psl_Restrict_Directive => 1794,
      Iir_Kind_Block_Statement => 1808,
      Iir_Kind_If_Generate_Statement => 1819,
      Iir_Kind_Case_Generate_Statement => 1828,
      Iir_Kind_For_Generate_Statement => 1837,
      Iir_Kind_Component_Instantiation_Statement => 1849,
      Iir_Kind_Psl_Default_Clock => 1852,
      Iir_Kind_Generate_Statement_Body => 1863,
      Iir_Kind_If_Generate_Else_Clause => 1869,
      Iir_Kind_Simple_Simultaneous_Statement => 1876,
      Iir_Kind_Simultaneous_Null_Statement => 1880,
      Iir_Kind_Simultaneous_Procedural_Statement => 1891,
      Iir_Kind_Simultaneous_Case_Statement => 1900,
      Iir_Kind_Simultaneous_If_Statement => 1909,
      Iir_Kind_Simultaneous_Elsif => 1915,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1926,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1937,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1949,
      Iir_Kind_Signal_Force_Assignment_Statement => 1959,
      Iir_Kind_Signal_Release_Assignment_Statement => 1968,
      Iir_Kind_Variable_Assignment_Statement => 1975,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 1982,
      Iir_Kind_Null_Statement => 1986,
      Iir_Kind_Assertion_Statement => 1993,
      Iir_Kind_Report_Statement => 1999,
      Iir_Kind_Next_Statement => 2006,
      Iir_Kind_Exit_Statement => 2013,
      Iir_Kind_Return_Statement => 2019,
      Iir_Kind_Procedure_Call_Statement => 2025,
      Iir_Kind_Wait_Statement => 2033,
      Iir_Kind_Break_Statement => 2040,
      Iir_Kind_For_Loop_Statement => 2051,
      Iir_Kind_While_Loop_Statement => 2062,
      Iir_Kind_Case_Statement => 2071,
      Iir_Kind_If_Statement => 2081,
      Iir_Kind_Suspend_State_Statement => 2086,
      Iir_Kind_Elsif => 2092,
      Iir_Kind_Character_Literal => 2099,
      Iir_Kind_Simple_Name => 2106,
      Iir_Kind_Selected_Name => 2114,
      Iir_Kind_Operator_Symbol => 2119,
      Iir_Kind_Reference_Name => 2124,
      Iir_Kind_External_Constant_Name => 2133,
      Iir_Kind_External_Signal_Name => 2143,
      Iir_Kind_External_Variable_Name => 2153,
      Iir_Kind_Selected_By_All_Name => 2159,
      Iir_Kind_Parenthesis_Name => 2165,
      Iir_Kind_Package_Pathname => 2169,
      Iir_Kind_Absolute_Pathname => 2170,
      Iir_Kind_Relative_Pathname => 2171,
      Iir_Kind_Pathname_Element => 2176,
      Iir_Kind_Base_Attribute => 2178,
      Iir_Kind_Subtype_Attribute => 2183,
      Iir_Kind_Element_Attribute => 2188,
      Iir_Kind_Across_Attribute => 2193,
      Iir_Kind_Through_Attribute => 2198,
      Iir_Kind_Nature_Reference_Attribute => 2202,
      Iir_Kind_Left_Type_Attribute => 2207,
      Iir_Kind_Right_Type_Attribute => 2212,
      Iir_Kind_High_Type_Attribute => 2217,
      Iir_Kind_Low_Type_Attribute => 2222,
      Iir_Kind_Ascending_Type_Attribute => 2227,
      Iir_Kind_Image_Attribute => 2233,
      Iir_Kind_Value_Attribute => 2239,
      Iir_Kind_Pos_Attribute => 2245,
      Iir_Kind_Val_Attribute => 2251,
      Iir_Kind_Succ_Attribute => 2257,
      Iir_Kind_Pred_Attribute => 2263,
      Iir_Kind_Leftof_Attribute => 2269,
      Iir_Kind_Rightof_Attribute => 2275,
      Iir_Kind_Signal_Slew_Attribute => 2283,
      Iir_Kind_Quantity_Slew_Attribute => 2291,
      Iir_Kind_Ramp_Attribute => 2299,
      Iir_Kind_Zoh_Attribute => 2307,
      Iir_Kind_Ltf_Attribute => 2315,
      Iir_Kind_Ztf_Attribute => 2325,
      Iir_Kind_Dot_Attribute => 2332,
      Iir_Kind_Integ_Attribute => 2339,
      Iir_Kind_Quantity_Delayed_Attribute => 2347,
