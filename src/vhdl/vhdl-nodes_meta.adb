...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Interface_View_Declaration => 1246,
      Iir_Kind_Interface_File_Declaration => 1262,
      Iir_Kind_Interface_Quantity_Declaration => 1278,
      Iir_Kind_Interface_Terminal_Declaration => 1290,
      Iir_Kind_Interface_Type_Declaration => 1302,
      Iir_Kind_Interface_Package_Declaration => 1316,
      Iir_Kind_Interface_Function_Declaration => 1336,
      Iir_Kind_Interface_Procedure_Declaration => 1352,
      Iir_Kind_Attribute_Implicit_Declaration => 1355,
      Iir_Kind_Suspend_State_Declaration => 1359,
      Iir_Kind_Identity_Operator => 1363,
      Iir_Kind_Negation_Operator => 1367,
      Iir_Kind_Absolute_Operator => 1371,
      Iir_Kind_Not_Operator => 1375,
      Iir_Kind_Implicit_Condition_Operator => 1379,
      Iir_Kind_Condition_Operator => 1383,
      Iir_Kind_Reduction_And_Operator => 1387,
      Iir_Kind_Reduction_Or_Operator => 1391,
      Iir_Kind_Reduction_Nand_Operator => 1395,
      Iir_Kind_Reduction_Nor_Operator => 1399,
      Iir_Kind_Reduction_Xor_Operator => 1403,
      Iir_Kind_Reduction_Xnor_Operator => 1407,
      Iir_Kind_And_Operator => 1412,
      Iir_Kind_Or_Operator => 1417,
      Iir_Kind_Nand_Operator => 1422,
      Iir_Kind_Nor_Operator => 1427,
      Iir_Kind_Xor_Operator => 1432,
      Iir_Kind_Xnor_Operator => 1437,
      Iir_Kind_Equality_Operator => 1442,
      Iir_Kind_Inequality_Operator => 1447,
      Iir_Kind_Less_Than_Operator => 1452,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1457,
      Iir_Kind_Greater_Than_Operator => 1462,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1467,
      Iir_Kind_Match_Equality_Operator => 1472,
      Iir_Kind_Match_Inequality_Operator => 1477,
      Iir_Kind_Match_Less_Than_Operator => 1482,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1487,
      Iir_Kind_Match_Greater_Than_Operator => 1492,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1497,
      Iir_Kind_Sll_Operator => 1502,
      Iir_Kind_Sla_Operator => 1507,
      Iir_Kind_Srl_Operator => 1512,
      Iir_Kind_Sra_Operator => 1517,
      Iir_Kind_Rol_Operator => 1522,
      Iir_Kind_Ror_Operator => 1527,
      Iir_Kind_Addition_Operator => 1532,
      Iir_Kind_Substraction_Operator => 1537,
      Iir_Kind_Concatenation_Operator => 1542,
      Iir_Kind_Multiplication_Operator => 1547,
      Iir_Kind_Division_Operator => 1552,
      Iir_Kind_Modulus_Operator => 1557,
      Iir_Kind_Remainder_Operator => 1562,
      Iir_Kind_Exponentiation_Operator => 1567,
      Iir_Kind_Function_Call => 1575,
      Iir_Kind_Aggregate => 1583,
      Iir_Kind_Parenthesis_Expression => 1586,
      Iir_Kind_Qualified_Expression => 1590,
      Iir_Kind_Type_Conversion => 1595,
      Iir_Kind_Allocator_By_Expression => 1600,
      Iir_Kind_Allocator_By_Subtype => 1606,
      Iir_Kind_Selected_Element => 1614,
      Iir_Kind_Dereference => 1619,
      Iir_Kind_Implicit_Dereference => 1624,
      Iir_Kind_Slice_Name => 1631,
      Iir_Kind_Indexed_Name => 1637,
      Iir_Kind_Psl_Prev => 1643,
      Iir_Kind_Psl_Stable => 1648,
      Iir_Kind_Psl_Rose => 1653,
      Iir_Kind_Psl_Fell => 1658,
      Iir_Kind_Psl_Onehot => 1661,
      Iir_Kind_Psl_Onehot0 => 1664,
      Iir_Kind_Psl_Expression => 1666,
      Iir_Kind_Sensitized_Process_Statement => 1687,
      Iir_Kind_Process_Statement => 1707,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1720,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1733,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1748,
      Iir_Kind_Concurrent_Assertion_Statement => 1756,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1764,
      Iir_Kind_Concurrent_Break_Statement => 1774,
      Iir_Kind_Psl_Assert_Directive => 1788,
      Iir_Kind_Psl_Assume_Directive => 1800,
      Iir_Kind_Psl_Cover_Directive => 1813,
      Iir_Kind_Psl_Restrict_Directive => 1825,
      Iir_Kind_Block_Statement => 1839,
      Iir_Kind_If_Generate_Statement => 1850,
      Iir_Kind_Case_Generate_Statement => 1859,
      Iir_Kind_For_Generate_Statement => 1868,
      Iir_Kind_Component_Instantiation_Statement => 1880,
      Iir_Kind_Psl_Default_Clock => 1883,
      Iir_Kind_Generate_Statement_Body => 1894,
      Iir_Kind_If_Generate_Else_Clause => 1900,
      Iir_Kind_Simple_Simultaneous_Statement => 1907,
      Iir_Kind_Simultaneous_Null_Statement => 1911,
      Iir_Kind_Simultaneous_Procedural_Statement => 1922,
      Iir_Kind_Simultaneous_Case_Statement => 1931,
      Iir_Kind_Simultaneous_If_Statement => 1940,
      Iir_Kind_Simultaneous_Elsif => 1946,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1958,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1970,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1984,
      Iir_Kind_Signal_Force_Assignment_Statement => 1995,
      Iir_Kind_Signal_Release_Assignment_Statement => 2005,
      Iir_Kind_Variable_Assignment_Statement => 2013,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 2021,
      Iir_Kind_Selected_Variable_Assignment_Statement => 2031,
      Iir_Kind_Null_Statement => 2036,
      Iir_Kind_Assertion_Statement => 2044,
      Iir_Kind_Report_Statement => 2051,
      Iir_Kind_Next_Statement => 2059,
      Iir_Kind_Exit_Statement => 2067,
      Iir_Kind_Return_Statement => 2074,
      Iir_Kind_Procedure_Call_Statement => 2081,
      Iir_Kind_Wait_Statement => 2090,
      Iir_Kind_Break_Statement => 2098,
      Iir_Kind_For_Loop_Statement => 2110,
      Iir_Kind_While_Loop_Statement => 2122,
      Iir_Kind_Case_Statement => 2132,
      Iir_Kind_If_Statement => 2143,
      Iir_Kind_Suspend_State_Statement => 2149,
      Iir_Kind_Elsif => 2156,
      Iir_Kind_Character_Literal => 2163,
      Iir_Kind_Simple_Name => 2170,
      Iir_Kind_Selected_Name => 2178,
      Iir_Kind_Operator_Symbol => 2183,
      Iir_Kind_Reference_Name => 2188,
      Iir_Kind_External_Constant_Name => 2198,
      Iir_Kind_External_Signal_Name => 2212,
      Iir_Kind_External_Variable_Name => 2223,
      Iir_Kind_Selected_By_All_Name => 2229,
      Iir_Kind_Parenthesis_Name => 2235,
      Iir_Kind_Package_Pathname => 2239,
      Iir_Kind_Absolute_Pathname => 2240,
      Iir_Kind_Relative_Pathname => 2241,
      Iir_Kind_Pathname_Element => 2246,
      Iir_Kind_Box_Name => 2246,
      Iir_Kind_Base_Attribute => 2248,
      Iir_Kind_Subtype_Attribute => 2253,
      Iir_Kind_Element_Attribute => 2258,
      Iir_Kind_Across_Attribute => 2263,
      Iir_Kind_Through_Attribute => 2268,
      Iir_Kind_Nature_Reference_Attribute => 2272,
      Iir_Kind_Left_Type_Attribute => 2277,
      Iir_Kind_Right_Type_Attribute => 2282,
      Iir_Kind_High_Type_Attribute => 2287,
      Iir_Kind_Low_Type_Attribute => 2292,
      Iir_Kind_Ascending_Type_Attribute => 2297,
      Iir_Kind_Image_Attribute => 2303,
      Iir_Kind_Value_Attribute => 2309,
      Iir_Kind_Pos_Attribute => 2315,
      Iir_Kind_Val_Attribute => 2321,
      Iir_Kind_Succ_Attribute => 2327,
      Iir_Kind_Pred_Attribute => 2333,
      Iir_Kind_Leftof_Attribute => 2339,
      Iir_Kind_Rightof_Attribute => 2345,
      Iir_Kind_Signal_Slew_Attribute => 2353,
      Iir_Kind_Quantity_Slew_Attribute => 2361,
      Iir_Kind_Ramp_Attribute => 2369,
      Iir_Kind_Zoh_Attribute => 2377,
      Iir_Kind_Ltf_Attribute => 2385,
      Iir_Kind_Ztf_Attribute => 2395,
      Iir_Kind_Dot_Attribute => 2401,
      Iir_Kind_Integ_Attribute => 2407,
      Iir_Kind_Quantity_Delayed_Attribute => 2414,
      Iir_Kind_Above_Attribute => 2422,
      Iir_Kind_Delayed_Attribute => 2430,
      Iir_Kind_Stable_Attribute => 2438,
      Iir_Kind_Quiet_Attribute => 2446,
      Iir_Kind_Transaction_Attribute => 2454,
      Iir_Kind_Event_Attribute => 2458,
      Iir_Kind_Active_Attribute => 2462,
      Iir_Kind_Last_Event_Attribute => 2466,
      Iir_Kind_Last_Active_Attribute => 2470,
      Iir_Kind_Last_Value_Attribute => 2474,
      Iir_Kind_Driving_Attribute => 2478,
      Iir_Kind_Driving_Value_Attribute => 2482,
      Iir_Kind_Behavior_Attribute => 2482,
      Iir_Kind_Structure_Attribute => 2482,
      Iir_Kind_Simple_Name_Attribute => 2489,
      Iir_Kind_Instance_Name_Attribute => 2494,
      Iir_Kind_Path_Name_Attribute => 2499,
      Iir_Kind_Converse_Attribute => 2501,
      Iir_Kind_Left_Array_Attribute => 2508,
      Iir_Kind_Right_Array_Attribute => 2515,
      Iir_Kind_High_Array_Attribute => 2522,
      Iir_Kind_Low_Array_Attribute => 2529,
      Iir_Kind_Length_Array_Attribute => 2536,
      Iir_Kind_Ascending_Array_Attribute => 2543,
      Iir_Kind_Range_Array_Attribute => 2550,
      Iir_Kind_Reverse_Range_Array_Attribute => 2557,
      Iir_Kind_Attribute_Name => 2566
     );
