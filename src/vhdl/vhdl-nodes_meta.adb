...
package body Vhdl.Nodes_Meta is
   ...
   Fields_Of_Iir_Last : constant array (Iir_Kind) of Fields_Index_Extended :=
     (
      ...
      Iir_Kind_Enumeration_Type_Definition => 429,
      Iir_Kind_Integer_Type_Definition => 438,
      Iir_Kind_Floating_Type_Definition => 447,
      Iir_Kind_Physical_Type_Definition => 459,
      Iir_Kind_Range_Expression => 467,
      Iir_Kind_Protected_Type_Body => 474,
      Iir_Kind_Wildcard_Type_Definition => 479,
      Iir_Kind_Subtype_Definition => 486,
      Iir_Kind_Scalar_Nature_Definition => 494,
      Iir_Kind_Record_Nature_Definition => 507,
      Iir_Kind_Array_Nature_Definition => 521,
      Iir_Kind_Array_Subnature_Definition => 536,
      Iir_Kind_Overload_List => 537,
      Iir_Kind_Entity_Declaration => 550,
      Iir_Kind_Configuration_Declaration => 559,
      Iir_Kind_Context_Declaration => 565,
      Iir_Kind_Package_Declaration => 580,
      Iir_Kind_Package_Instantiation_Declaration => 594,
      Iir_Kind_Vmode_Declaration => 605,
      Iir_Kind_Vprop_Declaration => 616,
      Iir_Kind_Vunit_Declaration => 628,
      Iir_Kind_Package_Body => 636,
      Iir_Kind_Architecture_Body => 649,
      Iir_Kind_Type_Declaration => 656,
      Iir_Kind_Anonymous_Type_Declaration => 662,
      Iir_Kind_Subtype_Declaration => 669,
      Iir_Kind_Nature_Declaration => 675,
      Iir_Kind_Subnature_Declaration => 682,
      Iir_Kind_Package_Header => 684,
      Iir_Kind_Unit_Declaration => 693,
      Iir_Kind_Library_Declaration => 701,
      Iir_Kind_Component_Declaration => 711,
      Iir_Kind_Attribute_Declaration => 718,
      Iir_Kind_Group_Template_Declaration => 724,
      Iir_Kind_Group_Declaration => 731,
      ...
      Iir_Kind_Terminal_Declaration => 865,
      Iir_Kind_Object_Alias_Declaration => 876,
      Iir_Kind_Free_Quantity_Declaration => 888,
      Iir_Kind_Spectrum_Quantity_Declaration => 901,
      Iir_Kind_Noise_Quantity_Declaration => 913,
      Iir_Kind_Across_Quantity_Declaration => 929,
      Iir_Kind_Through_Quantity_Declaration => 945,
      Iir_Kind_File_Declaration => 959,
      Iir_Kind_Guard_Signal_Declaration => 972,
      Iir_Kind_Signal_Declaration => 989,
      Iir_Kind_Variable_Declaration => 1002,
      Iir_Kind_Constant_Declaration => 1016,
      ...
      Iir_Kind_Interface_Type_Declaration => 1134,
      Iir_Kind_Interface_Package_Declaration => 1146,
      Iir_Kind_Interface_Function_Declaration => 1163,
      Iir_Kind_Interface_Procedure_Declaration => 1176,
      Iir_Kind_Anonymous_Signal_Declaration => 1185,
      Iir_Kind_Signal_Attribute_Declaration => 1188,
      Iir_Kind_Identity_Operator => 1192,
      Iir_Kind_Negation_Operator => 1196,
      Iir_Kind_Absolute_Operator => 1200,
      Iir_Kind_Not_Operator => 1204,
      Iir_Kind_Implicit_Condition_Operator => 1208,
      Iir_Kind_Condition_Operator => 1212,
      Iir_Kind_Reduction_And_Operator => 1216,
      Iir_Kind_Reduction_Or_Operator => 1220,
      Iir_Kind_Reduction_Nand_Operator => 1224,
      Iir_Kind_Reduction_Nor_Operator => 1228,
      Iir_Kind_Reduction_Xor_Operator => 1232,
      Iir_Kind_Reduction_Xnor_Operator => 1236,
      Iir_Kind_And_Operator => 1241,
      Iir_Kind_Or_Operator => 1246,
      Iir_Kind_Nand_Operator => 1251,
      Iir_Kind_Nor_Operator => 1256,
      Iir_Kind_Xor_Operator => 1261,
      Iir_Kind_Xnor_Operator => 1266,
      Iir_Kind_Equality_Operator => 1271,
      Iir_Kind_Inequality_Operator => 1276,
      Iir_Kind_Less_Than_Operator => 1281,
      Iir_Kind_Less_Than_Or_Equal_Operator => 1286,
      Iir_Kind_Greater_Than_Operator => 1291,
      Iir_Kind_Greater_Than_Or_Equal_Operator => 1296,
      Iir_Kind_Match_Equality_Operator => 1301,
      Iir_Kind_Match_Inequality_Operator => 1306,
      Iir_Kind_Match_Less_Than_Operator => 1311,
      Iir_Kind_Match_Less_Than_Or_Equal_Operator => 1316,
      Iir_Kind_Match_Greater_Than_Operator => 1321,
      Iir_Kind_Match_Greater_Than_Or_Equal_Operator => 1326,
      Iir_Kind_Sll_Operator => 1331,
      Iir_Kind_Sla_Operator => 1336,
      Iir_Kind_Srl_Operator => 1341,
      Iir_Kind_Sra_Operator => 1346,
      Iir_Kind_Rol_Operator => 1351,
      Iir_Kind_Ror_Operator => 1356,
      Iir_Kind_Addition_Operator => 1361,
      Iir_Kind_Substraction_Operator => 1366,
      Iir_Kind_Concatenation_Operator => 1371,
      Iir_Kind_Multiplication_Operator => 1376,
      Iir_Kind_Division_Operator => 1381,
      Iir_Kind_Modulus_Operator => 1386,
      Iir_Kind_Remainder_Operator => 1391,
      Iir_Kind_Exponentiation_Operator => 1396,
      Iir_Kind_Function_Call => 1404,
      Iir_Kind_Aggregate => 1411,
      Iir_Kind_Parenthesis_Expression => 1414,
      Iir_Kind_Qualified_Expression => 1418,
      Iir_Kind_Type_Conversion => 1423,
      Iir_Kind_Allocator_By_Expression => 1427,
      Iir_Kind_Allocator_By_Subtype => 1432,
      Iir_Kind_Selected_Element => 1440,
      Iir_Kind_Dereference => 1445,
      Iir_Kind_Implicit_Dereference => 1450,
      Iir_Kind_Slice_Name => 1457,
      Iir_Kind_Indexed_Name => 1463,
      Iir_Kind_Psl_Expression => 1465,
      Iir_Kind_Sensitized_Process_Statement => 1486,
      Iir_Kind_Process_Statement => 1506,
      Iir_Kind_Concurrent_Simple_Signal_Assignment => 1519,
      Iir_Kind_Concurrent_Conditional_Signal_Assignment => 1532,
      Iir_Kind_Concurrent_Selected_Signal_Assignment => 1546,
      Iir_Kind_Concurrent_Assertion_Statement => 1554,
      Iir_Kind_Concurrent_Procedure_Call_Statement => 1561,
      Iir_Kind_Concurrent_Break_Statement => 1569,
      Iir_Kind_Psl_Assert_Directive => 1582,
      Iir_Kind_Psl_Assume_Directive => 1593,
      Iir_Kind_Psl_Cover_Directive => 1605,
      Iir_Kind_Psl_Restrict_Directive => 1616,
      Iir_Kind_Block_Statement => 1630,
      Iir_Kind_If_Generate_Statement => 1641,
      Iir_Kind_Case_Generate_Statement => 1650,
      Iir_Kind_For_Generate_Statement => 1659,
      Iir_Kind_Component_Instantiation_Statement => 1670,
      Iir_Kind_Psl_Default_Clock => 1674,
      Iir_Kind_Generate_Statement_Body => 1685,
      Iir_Kind_If_Generate_Else_Clause => 1691,
      Iir_Kind_Simple_Simultaneous_Statement => 1698,
      Iir_Kind_Simultaneous_Null_Statement => 1702,
      Iir_Kind_Simultaneous_Procedural_Statement => 1713,
      Iir_Kind_Simultaneous_Case_Statement => 1722,
      Iir_Kind_Simultaneous_If_Statement => 1731,
      Iir_Kind_Simultaneous_Elsif => 1737,
      Iir_Kind_Simple_Signal_Assignment_Statement => 1748,
      Iir_Kind_Conditional_Signal_Assignment_Statement => 1759,
      Iir_Kind_Selected_Waveform_Assignment_Statement => 1771,
      Iir_Kind_Null_Statement => 1775,
      Iir_Kind_Assertion_Statement => 1782,
      Iir_Kind_Report_Statement => 1788,
      Iir_Kind_Wait_Statement => 1796,
      Iir_Kind_Variable_Assignment_Statement => 1803,
      Iir_Kind_Conditional_Variable_Assignment_Statement => 1810,
      Iir_Kind_Return_Statement => 1816,
      Iir_Kind_For_Loop_Statement => 1827,
      Iir_Kind_While_Loop_Statement => 1838,
      Iir_Kind_Next_Statement => 1845,
      Iir_Kind_Exit_Statement => 1852,
      Iir_Kind_Case_Statement => 1860,
      Iir_Kind_Procedure_Call_Statement => 1866,
      Iir_Kind_Break_Statement => 1873,
      Iir_Kind_If_Statement => 1883,
      Iir_Kind_Elsif => 1889,
      Iir_Kind_Character_Literal => 1897,
      Iir_Kind_Simple_Name => 1905,
      Iir_Kind_Selected_Name => 1914,
      Iir_Kind_Operator_Symbol => 1920,
      Iir_Kind_Reference_Name => 1925,
      Iir_Kind_External_Constant_Name => 1933,
      Iir_Kind_External_Signal_Name => 1941,
      Iir_Kind_External_Variable_Name => 1950,
      Iir_Kind_Selected_By_All_Name => 1956,
      Iir_Kind_Parenthesis_Name => 1961,
      Iir_Kind_Package_Pathname => 1965,
      Iir_Kind_Absolute_Pathname => 1966,
      Iir_Kind_Relative_Pathname => 1967,
      Iir_Kind_Pathname_Element => 1972,
      Iir_Kind_Base_Attribute => 1974,
      Iir_Kind_Subtype_Attribute => 1979,
      Iir_Kind_Element_Attribute => 1984,
      Iir_Kind_Across_Attribute => 1989,
      Iir_Kind_Through_Attribute => 1994,
      Iir_Kind_Nature_Reference_Attribute => 1998,
      Iir_Kind_Left_Type_Attribute => 2003,
      Iir_Kind_Right_Type_Attribute => 2008,
      Iir_Kind_High_Type_Attribute => 2013,
      Iir_Kind_Low_Type_Attribute => 2018,
      Iir_Kind_Ascending_Type_Attribute => 2023,
      Iir_Kind_Image_Attribute => 2029,
      Iir_Kind_Value_Attribute => 2035,
      Iir_Kind_Pos_Attribute => 2041,
      Iir_Kind_Val_Attribute => 2047,
      Iir_Kind_Succ_Attribute => 2053,
      Iir_Kind_Pred_Attribute => 2059,
      Iir_Kind_Leftof_Attribute => 2065,
      Iir_Kind_Rightof_Attribute => 2071,
      Iir_Kind_Signal_Slew_Attribute => 2079,
      Iir_Kind_Quantity_Slew_Attribute => 2087,
      Iir_Kind_Ramp_Attribute => 2095,
      Iir_Kind_Zoh_Attribute => 2103,
      Iir_Kind_Ltf_Attribute => 2111,
      Iir_Kind_Ztf_Attribute => 2121,
      Iir_Kind_Dot_Attribute => 2128,
      Iir_Kind_Integ_Attribute => 2135,
      Iir_Kind_Above_Attribute => 2143,
      Iir_Kind_Quantity_Delayed_Attribute => 2151,
      Iir_Kind_Delayed_Attribute => 2160,
      Iir_Kind_Stable_Attribute => 2169,
      Iir_Kind_Quiet_Attribute => 2178,
      Iir_Kind_Transaction_Attribute => 2187,
      Iir_Kind_Event_Attribute => 2191,
      Iir_Kind_Active_Attribute => 2195,
      Iir_Kind_Last_Event_Attribute => 2199,
      Iir_Kind_Last_Active_Attribute => 2203,
      Iir_Kind_Last_Value_Attribute => 2207,
      Iir_Kind_Driving_Attribute => 2211,
      Iir_Kind_Driving_Value_Attribute => 2215,
      Iir_Kind_Behavior_Attribute => 2215,
      Iir_Kind_Structure_Attribute => 2215,
      Iir_Kind_Simple_Name_Attribute => 2222,
      Iir_Kind_Instance_Name_Attribute => 2227,
      Iir_Kind_Path_Name_Attribute => 2232,
      Iir_Kind_Left_Array_Attribute => 2239,
      Iir_Kind_Right_Array_Attribute => 2246,
      Iir_Kind_High_Array_Attribute => 2253,
      Iir_Kind_Low_Array_Attribute => 2260,
      Iir_Kind_Length_Array_Attribute => 2267,
      Iir_Kind_Ascending_Array_Attribute => 2274,
      Iir_Kind_Range_Array_Attribute => 2281,
      Iir_Kind_Reverse_Range_Array_Attribute => 2288,
      Iir_Kind_Attribute_Name => 2297
     );
