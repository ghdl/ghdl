...
package LLVM.Core is
   ...
   type AttributeIndex is new unsigned;
   AttributeReturnIndex     : constant AttributeIndex := 0;
   AttributeFunctionIndex   : constant AttributeIndex := 16#ffff_ffff#;

   type AttributeRef is new System.Address;
   ...
   --  Attribute index
   function GetEnumAttributeKindForName (Name : Cstring; Len : unsigned)
                                        return unsigned;
   function GetLastEnumAttributeKind return unsigned;

   function CreateEnumAttribute
     (C : ContextRef; KindID : unsigned; Val : Unsigned_64)
     return AttributeRef;
...
private
   ...
   pragma Import (C, GetEnumAttributeKindForName,
                  "LLVMGetEnumAttributeKindForName");
   pragma Import (C, GetLastEnumAttributeKind,
                  "LLVMGetLastEnumAttributeKind");
   pragma Import (C, CreateEnumAttribute,
                  "LLVMCreateEnumAttribute");
   pragma Import (C, AddAttributeAtIndex,
