...
$LibrarySourceFiles = [ordered]@{
	...
	"ieee" = @(
		...
		@{"Dir" = "ieee2008"; "File" = "math_real";                 "IncludedIn" = @(      1993, 2008); "Flavor" = @("all");      Options=@()},
		@{"Dir" = "ieee2008"; "File" = "math_real-body";            "IncludedIn" = @(      1993, 2008); "Flavor" = @("all");      Options=@()},
		@{"Dir" = "ieee2008"; "File" = "math_complex";              "IncludedIn" = @(      1993, 2008); "Flavor" = @("all");      Options=@()},
		@{"Dir" = "ieee2008"; "File" = "math_complex-body";         "IncludedIn" = @(      1993, 2008); "Flavor" = @("all");      Options=@()},
